...
!(function (t, e) {
  ...
  function Yn(t) {
    if (G(t)) {
      var e = Xn.get(t);
      return e || ((e = Bn(t, -0.1)), Xn.put(t, e)), e;
    }
    if (K(t)) {
      var n = k({}, t);
      return (
  ...
  function Kn(t, e, n, i) {
    for (var r = e.length, o = 0; o < r; o++) t[o] = jn(e[o], n[o], i);
    return t;
  }
  function $n(t, e, n, i) {
  ...
  function ti(t, e, n) {
    ...
    if (i.push && r.push) {
      ...
      if (o !== a)
        if (o > a) i.length = a;
        else for (var s = o; s < a; s++) i.push(1 === n ? r[s] : Zn.call(r[s]));
  ...
  function ei(t) {
    if (O(t)) {
      var e = t.length;
      if (O(t[0])) {
        for (var n = [], i = 0; i < e; i++) n.push(Zn.call(t[i]));
        return n;
      }
      return Zn.call(t);
    }
      ...
      return (
          ...
          for (
            ...
            (h.percent = h.time / t),
              a ||
                (s && u !== r - 1
                  ? ti(c, p, i)
                  : l && Jn(c.colorStops, p.colorStops));
          }
          if (
            !a &&
            5 !== i &&
        ...
        (t.prototype.step = function (t, e) {
          if (!this._finished) {
            ...
            if (i && r) {
              ...
              var y = o ? this._additiveValue : c ? oi : t[h];
              if (
                ((!ri(s) && !c) || y || (y = this._additiveValue = []),
                this.discrete)
              )
                ...
                (t[h] = {
                  ...
                  colorStops: N(v.colorStops, function (t, e) {
                    ...
                    return {
                      ...
                      color: ni(Kn([], t.color, n.color, g)),
                    };
                  }),
                  global: m.global,
                }),
                  _
                    ? ((t[h].x2 = jn(v.x2, m.x2, g)),
                      (t[h].y2 = jn(v.y2, m.y2, g)))
                    : (t[h].r = jn(v.r, m.r, g));
              } else if (c) Kn(y, i[a], r[a], g), o || (t[h] = ni(y));
              else {
                var x = jn(i[a], r[a], g);
        ...
        (t.prototype._addToTarget = function (t) {
          ...
          0 === e
            ? (t[n] = t[n] + i)
            : 3 === e
              ? (En(t[n], oi), $n(oi, oi, i, 1), (t[n] = ni(oi)))
              : 1 === e
                ? $n(t[n], t[n], i, 1)
                : 2 === e && Qn(t[n], t[n], i, 1);
        }),
          ...
          for (var r = this._tracks, o = 0; o < n.length; o++) {
            ...
            if (!s) {
              ...
              if (u) {
                var h = u.keyframes,
                  c = h[h.length - 1];
                (l = c && c.value), 3 === u.valType && l && (l = ni(l));
              } else l = this._target[a];
              if (null == l) continue;
              t > 0 && s.addKeyframe(0, ei(l), i), this._trackKeys.push(a);
            }
            s.addKeyframe(t, ei(e[a]), i);
          }
  ...
  var ui,
    ...
    ci = (function (t) {
      ...
      return (
        ...
        (e.prototype.update = function (t) {
          for (
            var e = li() - this._pausedTime, n = e - this._time, i = this._head;
            i;
        ...
        (e.prototype.start = function () {
          this._running ||
            ((this._time = li()), (this._pausedTime = 0), this._startLoop());
        }),
        ...
        (e.prototype.resume = function () {
          this._paused &&
            ((this._pausedTime += li() - this._pauseStart),
            (this._paused = !1));
        }),
    ...
    pi = r.domSupported,
      ...
      ((hi = { pointerdown: 1, pointerup: 1, pointermove: 1, pointerout: 1 }),
      {
        mouse: (ui = [
          'click',
          'dblclick',
        ...
        pointer: N(ui, function (t) {
          var e = t.replace('mouse', 'pointer');
          return hi.hasOwnProperty(e) ? e : t;
        }),
      }),
    di = ['mousemove', 'mouseup'],
    gi = ['pointermove', 'pointerup'],
    yi = !1;
  function vi(t) {
    var e = t.pointerType;
  ...
  var xi = function (t, e) {
    ...
    wi = {
      ...
      mouseout: function (t) {
        _i(this, (t = re(this.dom, t)).toElement || t.relatedTarget) ||
          (this.__pointerCapturing && (t.zrEventControl = 'no_globalout'),
          this.trigger('mouseout', t));
      },
      wheel: function (t) {
        (yi = !0), (t = re(this.dom, t)), this.trigger('mousewheel', t);
      },
      mousewheel: function (t) {
        yi || ((t = re(this.dom, t)), this.trigger('mousewheel', t));
      },
      touchstart: function (t) {
        mi((t = re(this.dom, t))),
          (this.__lastTouchMoment = new Date()),
          this.handler.processGesture(t, 'start'),
          wi.mousemove.call(this, t),
          wi.mousedown.call(this, t);
      },
      ...
      touchend: function (t) {
        mi((t = re(this.dom, t))),
          ...
          +new Date() - +this.__lastTouchMoment < 300 && wi.click.call(this, t);
      },
      pointerdown: function (t) {
        wi.mousedown.call(this, t);
      },
      pointermove: function (t) {
        vi(t) || wi.mousemove.call(this, t);
      },
      pointerup: function (t) {
        wi.mouseup.call(this, t);
      },
      pointerout: function (t) {
        vi(t) || wi.mouseout.call(this, t);
      },
    };
  ...
  function Si(t, e) {
    ...
    r.pointerEventsSupported
      ? R(fi.pointer, function (i) {
          Ti(e, i, function (e) {
            n[i].call(t, e);
          });
        })
      : (r.touchEventsSupported &&
          R(fi.touch, function (i) {
            Ti(e, i, function (r) {
              n[i].call(t, r),
                (function (t) {
                  (t.touching = !0),
  ...
  function Mi(t, e) {
    ...
    r.pointerEventsSupported ? R(gi, n) : r.touchEventsSupported || R(di, n);
  }
  function Ti(t, e, n, i) {
    (t.mounted[e] = n),
      (t.listenerOpts[e] = i),
    ...
    Di = (function (t) {
      function e(e, n) {
        ...
        return (
          ...
          (i.dom = e),
          (i.painterRoot = n),
          (i._localHandlerScope = new ki(e, wi)),
          pi && (i._globalHandlerScope = new ki(document, bi)),
          Si(i, i._localHandlerScope),
          i
        );
      }
      return (
        n(e, t),
        (e.prototype.dispose = function () {
          Ci(this._localHandlerScope), pi && Ci(this._globalHandlerScope);
        }),
    ...
    Vi = (function () {
      ...
      return (
        ...
        (t.prototype.updateTransform = function () {
          ...
          e || t
            ? ((n = n || [1, 0, 0, 1, 0, 0]),
              e ? this.getLocalTransform(n) : Oi(n),
              t && (e ? ce(n, t, n) : he(n, t)),
              (this.transform = n),
              this._resolveGlobalScaleRatio(n))
            : n && (Oi(n), (this.invTransform = null));
        }),
        ...
        (t.prototype.decomposeTransform = function () {
          if (this.transform) {
            ...
            t &&
              t.transform &&
              ((t.invTransform = t.invTransform || [1, 0, 0, 1, 0, 0]),
              ce(zi, t.invTransform, e),
              (e = zi));
            var n = this.originX,
              i = this.originY;
            (n || i) &&
        ...
        (t.prototype.getLineScale = function () {
          ...
          return t && Fi(t[0] - 1) > 1e-10 && Fi(t[3] - 1) > 1e-10
            ? Math.sqrt(Fi(t[0] * t[3] - t[2] * t[1]))
            : 1;
        }),
        (t.prototype.copyTransform = function (t) {
          !(function (t, e) {
            for (var n = 0; n < Hi.length; n++) {
              var i = Hi[n];
              t[i] = e[i];
            }
          })(this, t);
  ...
  function Xi(t, e, n, i) {
    var r = ((t || '') + '').split('\n');
    if (1 === r.length) return Ui(r[0], e, n, i);
    ...
    nr = (function () {
      ...
      return (
            ...
            if ((r.copyTransform(e), null != n.position)) {
              ...
              n.layoutRect
                ...
                this.calculateTextPosition
                  ? this.calculateTextPosition(tr, n, u)
                  : Ki(tr, n, u),
                (r.x = tr.x),
                (r.y = tr.y),
                (o = tr.align),
              ...
              if (h && null != n.rotation) {
                ...
                'center' === h
                  ...
                  : ((c = ji(h[0], u.width)), (p = ji(h[1], u.height))),
                  (l = !0),
        ...
        (t.prototype.getOutsideFill = function () {
          return this.__zr && this.__zr.isDarkMode() ? Pi : Li;
        }),
        ...
        (t.prototype._innerSaveToNormal = function (t) {
          ...
          e || (e = this._normalState = {}),
            ...
            this._savePrimaryToNormal(t, e, Qi);
        }),
        ...
        (t.prototype._applyStateObj = function (t, e, n, i, r, o) {
          ...
          for (var s = {}, l = !1, u = 0; u < Qi.length; u++) {
            var h = Qi[u],
              c = r && Ji[h];
            e && null != e[h]
              ? c
        ...
        (t.prototype._transitionState = function (t, e, n, i) {
          for (var r = ir(this, e, n, i), o = 0; o < r.length; o++)
  ...
  function or(t, e, n) {
    if (O(e[n]))
      if ((O(t[n]) || (t[n] = []), Z(e[n]))) {
        var i = e[n].length;
        t[n].length !== i &&
          ((t[n] = new e[n].constructor(i)), rr(t[n], e[n], i));
      } else {
        var r = e[n],
          o = t[n],
          a = r.length;
      ...
      function t(t, e, n) {
        ...
        var u,
          h =
            r.node || r.worker || l
              ? null
              : new Di(s.getViewportRoot(), s.root),
        ...
        (t.prototype.setBackgroundColor = function (t) {
          this._disposed ||
            ...
            (this._darkMode = (function (t) {
              ...
              if (t.colorStops) {
                for (
                  var e = t.colorStops, n = 0, i = e.length, r = 0;
                  r < i;
                  r++
                )
                  n += Un(e[r].color, 1);
        ...
        (t.prototype.clear = function () {
          if (!this._disposed) {
            for (var t = this.storage.getRoots(), e = 0; e < t.length; e++)
              t[e] instanceof sr && t[e].removeSelfFromZr(this);
  ...
  var gr = Object.freeze({
      ...
      disposeAll: function () {
        for (var t in ur) ur.hasOwnProperty(t) && ur[t].dispose();
        ur = {};
      },
      ...
      getElementSSRData: function (t) {
        if ('function' == typeof hr) return hr(t);
      },
      registerSSRDataGetter: dr,
      version: '5.6.0',
    }),
    yr = 1e-4;
  function vr(t, e, n, i) {
    ...
    return (
            ...
            R(e, function (e) {
              if (e) {
                for (
                  ...
                  (i.newOption ||
                    Kr(i.existing) ||
                    (i.existing && null != e.id && !Yr('id', e, i.existing)));
      ...
      R(s, function (t, e) {
        var n = t.existing,
          ...
          r = t.keyInfo;
        if (Y(i)) {
          if (((r.name = null != i.name ? qr(i.name) : n ? n.name : Fr + e), n))
            r.id = qr(n.id);
          else if (null != i.id) r.id = qr(i.id);
          else {
            var o = 0;
            do {
              r.id = '\0' + r.name + '\0' + o++;
  ...
  function jr(t) {
    var e = t.name;
    return !(!e || !e.indexOf(Fr));
  }
  function Kr(t) {
    return t && null != t.id && 0 === qr(t.id).indexOf('\0_ec_\0');
  }
  function $r(t, e) {
  ...
  var no = { useDefault: !0, enableAll: !1, enableNone: !1 };
  function io(t, e, n, i) {
    i = i || no;
    var r = n.index,
      o = n.id,
  ...
  var ho = Math.round(10 * Math.random());
  function co(t, e) {
  ...
  function xo(t, e, n, i, r) {
    if (t) {
      if ('string' == typeof t) {
        ...
        return (
          o
            ? !bo((e = o.image)) && o.pending.push(a)
            : (((e = u.loadImage(t, wo, wo)).__zrImageSrc = t),
              mo.put(t, (e.__cachedImgObj = { image: e, pending: [a] }))),
          e
        );
      }
      return t;
  ...
  function Mo(t, e, n, i, r) {
    ...
    var o = (t + '').split('\n');
    r = To(e, n, i, r);
    for (var a = 0, s = o.length; a < s; a++) o[a] = Co(o[a], r);
    return o.join('\n');
  }
  function To(t, e, n, i) {
    var r = k({}, (i = i || {}));
  ...
  function Co(t, e) {
    ...
    for (var a = 0; ; a++) {
      ...
      var s =
        0 === a
          ? ko(t, r, e.ascCharWidth, e.cnCharWidth)
          : o > 0
  ...
  function Lo(t, e, n, i, r) {
    ...
    if (i) {
      ...
      if (null != l.width && 'auto' !== l.width) {
        var d = ji(l.width, i.width) + f;
        u.length > 0 &&
          d + i.accumWidth > i.width &&
          ((o = e.split('\n')), (c = !0)),
          (i.accumWidth = d);
      } else {
        var g = Ro(e, h, i.width, i.breakAll, i.accumWidth);
    ...
    for (var y = 0; y < o.length; y++) {
      ...
      if (
        ...
        var _ = (u[u.length - 1] || (u[0] = new Io())).tokens,
          x = _.length;
  ...
  var No = '__zr_style_' + Math.round(10 * Math.random()),
    Eo = {
      shadowBlur: 0,
      shadowOffsetX: 0,
      shadowOffsetY: 0,
      ...
      return (
        ...
        (e.prototype.shouldBePainted = function (t, e, n, i) {
          ...
          if (
            ...
            (this.culling &&
              (function (t, e, n) {
                Ho.copy(t.getBoundingRect()),
                  t.transform && Ho.applyTransform(t.transform);
                return (Wo.width = e), (Wo.height = n), !Ho.intersect(Wo);
              })(this, t, e)) ||
            (r && !r[0] && !r[3])
          )
            return !1;
        ...
        (e.prototype.setStyle = function (t, e) {
          return (
            'string' == typeof t ? (this.style[t] = e) : k(this.style, t),
            this.dirtyStyle(),
            this
          );
        }),
        ...
        (e.prototype._innerSaveToNormal = function (e) {
          ...
          e.style &&
            ...
            this._savePrimaryToNormal(e, n, Bo);
        }),
  ...
  function $o(t, e, n, i, r, o) {
    (r[0] = Go(t, n)), (r[1] = Go(e, i)), (o[0] = Uo(t, n)), (o[1] = Uo(e, i));
  }
  var Qo = [],
    Jo = [];
  function ta(t, e, n, i, r, o, a, s, l, u) {
    var h = hn,
      c = sn,
      p = h(t, n, r, a, Qo);
    (l[0] = 1 / 0), (l[1] = 1 / 0), (u[0] = -1 / 0), (u[1] = -1 / 0);
    for (var f = 0; f < p; f++) {
      var d = c(t, n, r, a, Qo[f]);
      (l[0] = Go(d, l[0])), (u[0] = Uo(d, u[0]));
    }
    p = h(e, i, o, s, Jo);
    for (f = 0; f < p; f++) {
      var g = c(e, i, o, s, Jo[f]);
      (l[1] = Go(g, l[1])), (u[1] = Uo(g, u[1]));
    }
    (l[0] = Go(t, l[0])),
      (u[0] = Uo(t, u[0])),
      (l[0] = Go(a, l[0])),
  ...
  var ia = { M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7 },
    ra = [],
    oa = [],
    aa = [],
    sa = [],
  ...
  var wa = (function () {
    ...
    return (
      ...
      (t.prototype.setScale = function (t, e, n) {
        (n = n || 0) > 0 &&
          ((this._ux = da(n / Ai / t) || 0), (this._uy = da(n / Ai / e) || 0));
      }),
      ...
      (t.prototype.arc = function (t, e, n, i, r, o) {
        this._drawPendingPt(), (ma[0] = i), (ma[1] = r), xa(ma, o), (i = ma[0]);
        var a = (r = ma[1]) - i;
        return (
          this.addData(ia.A, t, e, n, n, i, a, 0, o ? 0 : 1),
      ...
      (t.prototype.rect = function (t, e, n, i) {
        return (
          ...
          this.addData(ia.R, t, e, n, i),
          this
        );
      }),
      (t.prototype.closePath = function () {
        this._drawPendingPt(), this.addData(ia.Z);
        var t = this._ctx,
          e = this._x0,
          n = this._y0;
      ...
      (t.prototype.toStatic = function () {
        if (this._saveData) {
          ...
          t instanceof Array &&
            ((t.length = this._len),
            va && this._len > 11 && (this.data = new Float32Array(t)));
        }
      }),
      (t.prototype.getBoundingRect = function () {
        (aa[0] = aa[1] = la[0] = la[1] = Number.MAX_VALUE),
          (sa[0] = sa[1] = ua[0] = ua[1] = -Number.MAX_VALUE);
        var t,
          e = this.data,
          n = 0,
          i = 0,
        ...
        for (t = 0; t < this._len; ) {
          ...
          switch ((s && ((r = n = e[t]), (o = i = e[t + 1])), a)) {
            case ia.M:
              ...
              break;
            case ia.L:
              $o(n, i, e[t], e[t + 1], la, ua), (n = e[t++]), (i = e[t++]);
              break;
            case ia.C:
              ta(n, i, e[t++], e[t++], e[t++], e[t++], e[t], e[t + 1], la, ua),
                (n = e[t++]),
                (i = e[t++]);
              break;
            case ia.Q:
              ea(n, i, e[t++], e[t++], e[t], e[t + 1], la, ua),
                (n = e[t++]),
                (i = e[t++]);
              break;
            case ia.A:
              ...
              t += 1;
              var d = !e[t++];
              s && ((r = pa(p) * h + l), (o = fa(p) * c + u)),
                na(l, u, h, c, p, f, d, la, ua),
                (n = pa(f) * h + l),
                (i = fa(f) * c + u);
              break;
            case ia.R:
          ...
          zt(aa, aa, la), Bt(sa, sa, ua);
        }
        return (
          0 === t && (aa[0] = aa[1] = sa[0] = sa[1] = 0),
          new Ce(aa[0], aa[1], sa[0] - aa[0], sa[1] - aa[1])
        );
      }),
        ...
        for (var l = this._pathSegLen, u = 0, h = 0, c = 0; c < e; ) {
          ...
          switch (p) {
            ...
            case ia.L:
              var g = t[c++],
                y = (_ = t[c++]) - o;
              (da((I = g - r)) > n || da(y) > i || c === e - 1) &&
                ((d = Math.sqrt(I * I + y * y)), (r = g), (o = _));
              break;
            case ia.C:
              var v = t[c++],
                m = t[c++],
            ...
            case ia.A:
              var b = t[c++],
                ...
                D = k + C;
              (c += 1),
                f && ((a = pa(C) * M + b), (s = fa(C) * T + S)),
                (d = ca(M, T) * ha(ya, Math.abs(k))),
                (r = pa(D) * M + b),
                (o = fa(D) * T + S);
              break;
            case ia.R:
          ...
          t: for (var x = 0; x < g; ) {
            ...
            switch (
              ...
              case ia.C:
                ...
                if (y) {
                  if (v + (Z = l[m++]) > u) {
                    cn(r, k, I, L, (T = (u - v) / Z), ra),
                      cn(o, D, A, P, T, oa),
                      t.bezierCurveTo(ra[1], oa[1], ra[2], oa[2], ra[3], oa[3]);
                    break t;
                  }
                  v += Z;
                }
                t.bezierCurveTo(k, D, I, A, L, P), (r = L), (o = P);
                break;
              case ia.Q:
                (k = p[x++]), (D = p[x++]), (I = p[x++]), (A = p[x++]);
                if (y) {
                  if (v + (Z = l[m++]) > u) {
                    yn(r, k, I, (T = (u - v) / Z), ra),
                      yn(o, D, A, T, oa),
                      t.quadraticCurveTo(ra[1], oa[1], ra[2], oa[2]);
                    break t;
                  }
                  v += Z;
                }
                t.quadraticCurveTo(k, D, I, A), (r = I), (o = A);
                break;
              case ia.A:
                var O = p[x++],
                  R = p[x++],
              ...
              case ia.R:
                ...
                if (y) {
                  if (v + (Z = l[m++]) > u) {
                    ...
                    t.moveTo(a, s),
                      t.lineTo(a + ha(q, X), s),
                      (q -= X) > 0 && t.lineTo(a + X, s + ha(q, Y)),
                      (q -= Y) > 0 && t.lineTo(a + ca(X - q, 0), s + Y),
                      (q -= X) > 0 && t.lineTo(a, s + ca(Y - q, 0));
                    break t;
                  }
                  v += Z;
                }
  ...
  function Sa(t, e, n, i, r, o, a, s, l, u, h) {
    if (0 === l) return !1;
    var c = l;
    if (
  ...
  var Ta = 2 * Math.PI;
  function Ca(t) {
    return (t %= Ta) < 0 && (t += Ta), t;
  }
  var ka = 2 * Math.PI;
  function Da(t, e, n, i, r, o, a, s, l) {
    if (0 === a) return !1;
    var u = a;
    (s -= t), (l -= e);
    var h = Math.sqrt(s * s + l * l);
    if (h - u > n || h + u < n) return !1;
    if (Math.abs(i - r) % ka < 1e-4) return !0;
    if (o) {
      var c = i;
      (i = Ca(r)), (r = Ca(c));
    } else (i = Ca(i)), (r = Ca(r));
    ...
    return (
      p < 0 && (p += ka), (p >= i && p <= r) || (p + ka >= i && p + ka <= r)
    );
  }
  ...
  var Pa = [-1, -1, -1],
    Oa = [-1, -1];
  function Ra(t, e, n, i, r, o, a, s, l, u) {
    if (
      (u > e && u > i && u > o && u > s) ||
      (u < e && u < i && u < o && u < s)
    )
    ...
    for (var p = 0, f = -1, d = void 0, g = void 0, y = 0; y < c; y++) {
      ...
      sn(t, n, r, a, v) < l ||
        (f < 0 &&
          ...
          Oa[1] < Oa[0] &&
            f > 1 &&
            ((h = void 0), (h = Oa[0]), (Oa[0] = Oa[1]), (Oa[1] = h)),
          (d = sn(e, i, o, s, Oa[0])),
          f > 1 && (g = sn(e, i, o, s, Oa[1]))),
        2 === f
          ? v < Oa[0]
            ? (p += d < e ? m : -m)
            : v < Oa[1]
  ...
  function Na(t, e, n, i, r, o, a, s) {
    ...
    if (u >= 0 && u <= 1) {
      for (var h = 0, c = fn(e, i, o, u), p = 0; p < l; p++) {
        var f = 0 === Pa[p] || 1 === Pa[p] ? 0.5 : 1;
        fn(t, n, r, Pa[p]) < a ||
          (Pa[p] < u ? (h += c < e ? f : -f) : (h += o < c ? f : -f));
      }
      return h;
    }
    f = 0 === Pa[0] || 1 === Pa[0] ? 0.5 : 1;
    return fn(t, n, r, Pa[0]) < a ? 0 : o < e ? f : -f;
  }
  function Ea(t, e, n, i, r, o, a, s) {
  ...
  function za(t, e, n, i, r) {
    for (
      ...
      switch (
        ...
        case Aa.L:
          if (n) {
            if (ba(p, f, u[y], u[y + 1], e, i, r)) return !0;
          } else c += Ia(p, f, u[y], u[y + 1], i, r) || 0;
          (p = u[y++]), (f = u[y++]);
          break;
        case Aa.C:
          if (n) {
            if (
              Sa(p, f, u[y++], u[y++], u[y++], u[y++], u[y], u[y + 1], e, i, r)
            )
              return !0;
          } else
            c +=
              Ra(p, f, u[y++], u[y++], u[y++], u[y++], u[y], u[y + 1], i, r) ||
              0;
          (p = u[y++]), (f = u[y++]);
          break;
        case Aa.Q:
          if (n) {
            if (Ma(p, f, u[y++], u[y++], u[y], u[y + 1], e, i, r)) return !0;
          } else c += Na(p, f, u[y++], u[y++], u[y], u[y + 1], i, r) || 0;
          (p = u[y++]), (f = u[y++]);
          break;
        case Aa.A:
          var _ = u[y++],
          ...
          (o = Math.cos(S) * w + _),
            (a = Math.sin(S) * b + x),
            m ? ((d = o), (g = a)) : (c += Ia(p, f, o, a, i, r));
          var C = ((i - _) * b) / w + _;
          if (n) {
            if (Da(_, x, b, S, S + M, T, e, C, r)) return !0;
          } else c += Ea(_, x, b, S, S + M, T, C, r);
        ...
        case Aa.R:
          if (
            ...
            if (
              ...
              return !0;
          } else (c += Ia(o, g, o, a, i, r)), (c += Ia(d, a, d, g, i, r));
          break;
        case Aa.Z:
          if (n) {
            if (ba(p, f, d, g, e, i, r)) return !0;
          } else c += Ia(p, f, d, g, i, r);
          (p = d), (f = g);
      }
    }
    return (
  ...
  var Ba = D(
    ...
    Va = Hi.concat(['invisible', 'culling', 'z', 'z2', 'zlevel', 'parent']),
    Ha = (function (t) {
      function e(e) {
        return t.call(this, e) || this;
      }
      ...
      return (
        ...
        (e.prototype.update = function () {
          ...
          if (i.decal) {
            ...
            for (var s = 0; s < Va.length; ++s) r[Va[s]] = this[Va[s]];
            r.__dirty |= 1;
          ...
          if (
            (n && n.shape
              ? o
                ? r
                  ? (s = n.shape)
                  : ((s = k({}, i.shape)), k(s, n.shape))
                : ((s = k({}, r ? this.shape : i.shape)), k(s, n.shape))
              : l && (s = i.shape),
            s)
          )
            if (o) {
      ...
      return (
        ...
        (e.prototype.getBoundingRect = function () {
          ...
          if (!this._rect) {
            var e = t.text;
            null != e ? (e += '') : (e = '');
            var n = Xi(e, t.font, t.textAlign, t.textBaseline);
  ...
  function Za(t, e, n) {
    if (e) {
      ...
      var s = n && n.lineWidth;
      return s
        ? (qa(2 * i) === qa(2 * r) && (t.x1 = t.x2 = ja(i, s, !0)),
          qa(2 * o) === qa(2 * a) && (t.y1 = t.y2 = ja(o, s, !0)),
          t)
        : t;
    }
  }
  function ja(t, e, n) {
    if (!e) return t;
    var i = qa(2 * t);
    return (i + qa(e)) % 2 == 0 ? i / 2 : (i + (n ? 1 : -1)) / 2;
  }
  var Ka = function () {
  ...
  var Ja = { fill: '#000' },
    ...
    es = (function (t) {
      ...
      return (
        ...
        (e.prototype._updatePlainTexts = function () {
          var t = this.style,
            ...
            i = (function (t, e) {
                  ...
                  (n =
                    null == c || ('break' !== i && 'breakAll' !== i)
                      ? t
                        ...
                        : []
                      : t
                        ? Ro(t, e.font, c, 'breakAll' === i, 0).lines
                        : []).length * l,
                f = et(e.height, p);
              if (p > f && h) {
              ...
              var v = f,
                m = 0;
              for (y = 0; y < n.length; y++) m = Math.max(Gi(n[y], o), m);
              null == c && (c = m);
              var _ = m;
              return (
                r &&
          ...
          for (
            var w = 0,
              b = !1,
              S = us(('fill' in t) ? t.fill : ((b = !0), p.fill)),
              M = ls(
                ('stroke' in t)
                  ? t.stroke
                  : a || (p.autoStroke && !b)
            ...
            var I = this._getOrCreateChild(Ga),
              A = I.createStyle();
            I.useStyle(A),
              (A.text = h[D]),
              (A.x = v),
              ...
              C &&
                I.setBoundingRect(
                  new Ce(
                    Yi(A.x, t.width, A.textAlign),
                    qi(A.y, k, A.textBaseline),
                    u,
                    k,
                  ),
                );
        ...
        (e.prototype._updateRichTexts = function () {
          var t = this.style,
            e = (function (t, e) {
              ...
              for (
                ...
                var u = i.index;
                u > l && Lo(n, t.substring(l, u), e, s),
                  Lo(n, i[2], e, s, i[1]),
                  (l = So.lastIndex);
              }
              l < t.length && Lo(n, t.substring(l, t.length), e, s);
              var h = [],
                c = 0,
                p = 0,
                f = e.padding,
                  ...
                  if ('string' == typeof k && '%' === k.charAt(k.length - 1))
                    ...
                    null != L && L < P.width
                      ? !D || L < M
                        ...
                        : ((P.text = Mo(P.text, L - M, T, e.ellipsis, {
                            minChar: e.truncateMinChar,
                          })),
                          (P.width = P.contentWidth = Gi(P.text, T)))
                      : (P.contentWidth = Gi(P.text, T));
                  }
                  (P.width += M),
                    (x += P.width),
          ...
          o && ((f += o[3]), (d += o[0]));
          var g = f + n;
          ps(t) && this._renderBackground(t, t, c, p, i, r);
          for (var y = !!t.backgroundColor, v = 0; v < e.lines.length; v++) {
            for (
              ...
              this._placeToken(k, t, w, d, M, 'left', y),
                (b -= k.width),
                (M += k.width),
                S++;
            for (; C >= 0 && 'right' === (k = _[C]).align; )
              this._placeToken(k, t, w, d, T, 'right', y),
                (b -= k.width),
                (T -= k.width),
                C--;
            for (M += (n - (M - f) - (g - T) - b) / 2; S <= C; )
              (k = _[S]),
                this._placeToken(k, t, w, d, M + k.width / 2, 'center', y),
                (M += k.width),
                S++;
            d += w;
          }
        ...
        (e.prototype._placeToken = function (t, e, n, i, r, a, s) {
          ...
          var c = !!l.backgroundColor,
            p = t.textPadding;
          p &&
            ((r = hs(r, a, p)), (h -= t.height / 2 - p[0] - t.innerHeight / 2));
          var f = this._getOrCreateChild(Ga),
            d = f.createStyle();
          f.useStyle(d);
          ...
          var w = t.contentWidth,
            b = t.contentHeight;
          f.setBoundingRect(
            new Ce(Yi(d.x, w, d.textAlign), qi(d.y, b, d.textBaseline), w, b),
          );
        }),
        (e.prototype._renderBackground = function (t, e, n, i, r, o) {
          ...
          if (f)
            ...
            (s = this._getOrCreateChild(Ya)).onload = function () {
              g.dirtyStyle();
            };
            var v = s.style;
            (v.image = u.image),
    ...
    ns = { left: !0, right: 1, center: 1 },
    is = { top: 1, bottom: 1, middle: 1 },
    rs = ['fontStyle', 'fontWeight', 'fontSize', 'fontFamily'];
  function os(t) {
    return 'string' != typeof t ||
      (-1 === t.indexOf('px') &&
        -1 === t.indexOf('rem') &&
  ...
  function ss(t) {
    if (t) {
      t.font = es.makeFont(t);
      var e = t.align;
      'middle' === e && (e = 'center'),
        (t.align = null == e || ns[e] ? e : 'left');
      var n = t.verticalAlign;
      'center' === n && (n = 'middle'),
        (t.verticalAlign = null == n || is[n] ? n : 'top'),
  ...
  var fs = Qr(),
    ...
    _s = ['normal', 'emphasis', 'blur', 'select'],
    xs = 'highlight',
    ws = 'downplay',
    bs = 'select',
    Ss = 'unselect',
  ...
  function Ds(t) {
    2 === t.hoverState && Cs(t, 'normal', 0);
  }
  function Is(t) {
    Cs(t, 'blur', 1);
  }
  function As(t) {
    1 === t.hoverState && Cs(t, 'normal', 0);
  }
  function Ls(t) {
    t.selected = !0;
  }
        ...
        return (function (t, e, n, i) {
          ...
          if (t instanceof Ha) {
            ...
            if (Ts(s) || Ts(l)) {
              var u = (i = i || {}).style || {};
              'inherit' === u.fill
                ? ((o = !0), (i = k({}, i)), ((u = k({}, u)).fill = s))
                : !Ts(u.fill) && Ts(s)
                  ? ((o = !0), (i = k({}, i)), ((u = k({}, u)).fill = Yn(s)))
                  : !Ts(u.stroke) &&
                    Ts(l) &&
                    (o || ((i = k({}, i)), (u = k({}, u))), (u.stroke = Yn(l))),
                (i.style = u);
            }
          }
          if (i && null == i.z2) {
      ...
      if ('blur' === t)
        return (function (t, e, n) {
          ...
          return (
            null == a.opacity &&
              ((n = k({}, n)),
              (a = k({ opacity: i ? r : 0.1 * o.opacity }, a)),
              (n.style = a)),
            n
          );
        })(this, t, n);
  ...
  function zs(t) {
    ...
    e && (e.stateProxy = Es), n && (n.stateProxy = Es);
  }
  function Bs(t, e) {
    !Xs(t, e) && !t.__highByOuter && Rs(t, ks);
  }
  function Fs(t, e) {
    !Xs(t, e) && !t.__highByOuter && Rs(t, Ds);
  }
  function Vs(t, e) {
    (t.__highByOuter |= 1 << (e || 0)), Rs(t, ks);
  }
  function Hs(t, e) {
    !(t.__highByOuter &= ~(1 << (e || 0))) && Rs(t, Ds);
  }
  function Ws(t) {
    Rs(t, As);
  }
  ...
  function yl(t, e) {
    return (t[0] * e[0] + t[1] * e[1]) / (gl(t) * gl(e));
  }
  function vl(t, e) {
    return (t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(yl(t, e));
  }
  function ml(t, e, n, i, r, o, a, s, l, u, h) {
    var c = l * (dl / 180),
      p = (fl(c) * (t - n)) / 2 + (pl(c) * (e - i)) / 2,
      f = (-1 * pl(c) * (t - n)) / 2 + (fl(c) * (e - i)) / 2,
      d = (p * p) / (a * a) + (f * f) / (s * s);
    d > 1 && ((a *= cl(d)), (s *= cl(d)));
    var g =
        (r === o ? -1 : 1) *
      ...
      y = (g * a * f) / s,
      v = (g * -s * p) / a,
      m = (t + n) / 2 + fl(c) * y - pl(c) * v,
      _ = (e + i) / 2 + pl(c) * y + fl(c) * v,
      x = vl([1, 0], [(p - y) / a, (f - v) / s]),
      w = [(p - y) / a, (f - v) / s],
      b = [(-1 * p - y) / a, (-1 * f - v) / s],
      S = vl(w, b);
    if ((yl(w, b) <= -1 && (S = dl), yl(w, b) >= 1 && (S = 0), S < 0)) {
      var M = Math.round((S / dl) * 1e6) / 1e6;
      S = 2 * dl + (M % 2) * dl;
    }
    h.addData(u, m, _, a, s, x, S, c, o);
  }
  var _l = /([mlvhzcqtsa])([^mlvhzcqtsa]*)/gi,
    xl = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g;
  var wl = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
            ...
            for (r = 0, o = 0; r < u; ) {
              switch (((n = l[r++]), (o = r), (i = 0), n)) {
                ...
                case d:
                  var y = e[4],
                    v = e[5],
                    m = ul(e[0] * e[0] + e[1] * e[1]),
                    _ = ul(e[2] * e[2] + e[3] * e[3]),
                    x = hl(-e[1] / _, e[0] / m);
                  (l[r] *= m),
                    (l[r++] += y),
                    (l[r] *= _),
  ...
  function Vl(t, e) {
    ...
    if (o || r > 0) {
      ...
      if (!isNaN(s) && !isNaN(l)) {
        ...
        if ((f > Bl && (p = f), i > Bl))
          if (p > Il - Bl)
            t.moveTo(u + i * Ll(s), h + i * Al(s)),
              t.arc(u, h, i, s, l, !c),
              r > Bl &&
                (t.moveTo(u + r * Ll(l), h + r * Al(l)),
                t.arc(u, h, r, l, s, c));
          else {
            var d = void 0,
              g = void 0,
                  ...
                  var B = A - z[0],
                    ...
                    G =
                      ...
                      Al(
                        Pl(
                          (B * V + F * W) /
                            (Nl(B * B + F * F) * Nl(V * V + W * W)),
                        ) / 2,
                      ),
                    U = Nl(z[0] * z[0] + z[1] * z[1]);
                  (M = zl(b, (i - U) / (G + 1))),
                    (T = zl(S, (r - U) / (G - 1)));
                }
              }
                  ...
                  M < b && X === Y
                    ...
                    : (X > 0 &&
                      ...
                      t.arc(
                        ...
                        h,
                        i,
                        Ol(q.cy + q.y1, q.cx + q.x1),
                        Ol(Z.cy + Z.y1, Z.cx + Z.x1),
                        !c,
                      ),
                      Y > 0 &&
                        t.arc(
  ...
  var nu = (function (t) {
    ...
    return (
      ...
      (e.prototype.pointAt = function (t) {
        return eu(this.shape, t, !1);
      }),
      (e.prototype.tangentAt = function (t) {
        var e = eu(this.shape, t, !0);
        return At(e, e);
      }),
      e
    );
  })(Ha);
  nu.prototype.type = 'bezier-curve';
  var iu = function () {
      (this.cx = 0),
        (this.cy = 0),
        (this.r = 0),
      ...
      return (
        ...
        (e.prototype.getBoundingRect = function () {
          return (
            ...
            Ha.prototype.getBoundingRect.call(this)
          );
        }),
        e
      );
      ...
      return (
        ...
        (t.prototype.intersect = function (t, e) {
          ...
          return (
            cu.set(1 / 0, 1 / 0),
            pu.set(0, 0),
            (!this._intersectCheckOneSide(this, t, cu, pu, i, 1) &&
              ((n = !1), i)) ||
              (!this._intersectCheckOneSide(t, this, cu, pu, i, -1) &&
                ((n = !1), i)) ||
              i ||
              ve.copy(e, n ? cu : pu),
            n
        ...
        (t.prototype._intersectCheckOneSide = function (t, e, n, i, r, o) {
          for (var a = !0, s = 0; s < 2; s++) {
            var l = this._axes[s];
            if (
              (this._getProjMinMaxOnAxis(s, t._corners, uu),
              this._getProjMinMaxOnAxis(s, e._corners, hu),
              uu[1] < hu[0] || uu[0] > hu[1])
            ) {
              if (((a = !1), r)) return a;
              var u = Math.abs(hu[0] - uu[1]),
                h = Math.abs(uu[0] - hu[1]);
              Math.min(u, h) > i.len() &&
                (u < h ? ve.scale(i, l, -u * o) : ve.scale(i, l, h * o));
            } else if (n) {
              (u = Math.abs(hu[0] - uu[1])), (h = Math.abs(uu[0] - hu[1]));
              Math.min(u, h) < n.len() &&
          ...
          if (!this._rect) {
            for (
              ...
              n.needLocalTransform() &&
                i.applyTransform(n.getLocalTransform(du)),
                t.union(i);
            }
            this._rect = t;
          }
  ...
  function mu(t, e, n, i, r, o) {
    vu('update', t, e, n, i, r, o);
  }
  function _u(t, e, n, i, r, o) {
    vu('enter', t, e, n, i, r, o);
  }
  function xu(t) {
    if (!t.__zr) return !0;
  ...
  function wu(t, e, n, i, r, o) {
    xu(t) || vu('leave', t, e, n, i, r, o);
  }
  function bu(t, e, n, i) {
    t.removeTextContent(),
      t.removeTextGuideLine(),
      wu(t, { style: { opacity: 0 } }, e, n, i);
  }
  function Su(t, e, n) {
    function i() {
    ...
    t.isGroup
      ? t.traverse(function (t) {
          t.isGroup || bu(t, e, n, i);
        })
      : bu(t, e, n, i);
  }
  function Mu(t) {
    yu(t).oldStyle = t.style;
  }
  var Tu = Math.max,
    Cu = Math.min,
    ku = {};
  ...
  function Au(t, e, n, i) {
    var r = (function (t, e) {
      return new wl(Sl(t, e));
    })(t, e);
    return (
      n && ('center' === i && (n = Pu(n, r.getBoundingRect())), Ru(r, n)), r
    );
  }
  function Lu(t, e, n) {
    var i = new Ya({
  ...
  function Bu(t, e) {
    if (t)
      if (H(t)) for (var n = 0; n < t.length; n++) zu(t[n], e);
      else zu(t, e);
  }
  Iu('circle', Tl),
    Iu('ellipse', kl),
  ...
  function Vu(t, e, n) {
    ...
    for (var l = { normal: i }, u = 0; u < ms.length; u++) {
      var h = ms[u],
        c = e[h];
      l[h] = et(
  ...
  function Hu(t, e, n, i) {
    n = n || Fu;
    for (var r = t instanceof es, o = !1, a = 0; a < _s.length; a++) {
      if ((p = e[_s[a]]) && p.getShallow('show')) {
        o = !0;
        break;
      }
    }
    ...
    if (o) {
      r ||
        (s || ((s = new es()), t.setTextContent(s)),
        t.stateProxy && (s.stateProxy = t.stateProxy));
      var l = Vu(n, e),
        u = e.normal,
        h = !!u.getShallow('show'),
        c = Gu(u, i && i.normal, n, !1, !r);
      (c.text = l.normal), r || t.setTextConfig(Uu(u, n, !1));
      for (a = 0; a < ms.length; a++) {
        ...
        if ((p = e[f])) {
          ...
          if (
            (g !== h && (d.ignore = !g),
            (d.style = Gu(p, i && i[f], n, !0, !r)),
            (d.style.text = l[f]),
            !r)
          )
            t.ensureState(f).textConfig = Uu(p, n, !0);
        }
      }
  ...
  function Wu(t, e) {
    e = e || 'label';
    for (var n = { normal: t.getModel(e) }, i = 0; i < ms.length; i++) {
      var r = ms[i];
      n[r] = t.getModel([r, e]);
    }
    return n;
  ...
  function Zu(t, e, n, i, r, o, a, s) {
    ...
    for (var g = 0; g < Xu.length; g++) {
      var y = Xu[g];
      null != (m = et(e.getShallow(y), n[y])) && (t[y] = m);
    }
    for (g = 0; g < Yu.length; g++) {
      y = Yu[g];
    ...
    eh = (function () {
      ...
      return (
        (t.prototype.getTextColor = function (t) {
          var e = this.ecModel;
          return this.getShallow('color') || (!t && e ? e.get(Qu) : null);
        }),
        ...
        (t.prototype.getTextRect = function (t) {
          for (
            ...
            e[Ju[n]] = this.getShallow(Ju[n]);
          return th.useStyle(e), th.update(), th.getBoundingRect();
        }),
        t
      );
    })(),
  ...
  lo(lh),
    (Ku = lh),
    ($u = ['__\0is_clz', ho++].join('_')),
    (Ku.prototype[$u] = !0),
    (Ku.isInstance = function (t) {
      return !(!t || !t[$u]);
    }),
    P(lh, rh),
    P(lh, sh),
    P(lh, vo),
    P(lh, eh);
  var uh = Math.round(10 * Math.random());
  function hh(t) {
    return [t || '', uh++].join('_');
  }
  var ch = 'ZH',
    ...
    yh =
      ...
      (
        ...
        : fh;
  function vh(t, e) {
    (t = t.toUpperCase()), (gh[t] = new lh(e)), (dh[t] = e);
  }
  vh(ph, {
    time: {
      month: [
  ...
  var mh = 1e3,
    ...
    Ch = ['year', 'month', 'day', 'hour', 'minute', 'second', 'millisecond'],
    kh = [
      'year',
      'half-year',
      'quarter',
  ...
  function Lh(t, e, n, i) {
    var r = Dr(t),
      ...
      x = m.get('monthAbbr'),
      w = m.get('dayOfWeek'),
      b = m.get('dayOfWeekAbbr');
    return (e || '')
      .replace(/{a}/g, g + '')
      .replace(/{A}/g, y + '')
      .replace(/{yyyy}/g, o + '')
      .replace(/{yy}/g, Dh((o % 100) + '', 2))
      .replace(/{Q}/g, s + '')
      .replace(/{MMMM}/g, _[a - 1])
      .replace(/{MMM}/g, x[a - 1])
      .replace(/{MM}/g, Dh(a, 2))
      .replace(/{M}/g, a + '')
      .replace(/{dd}/g, Dh(l, 2))
  ...
  function Qh(t, e, n) {
    ...
    for (var r = e[0].$vars || [], o = 0; o < r.length; o++) {
      var a = Kh[o];
      t = t.replace($h(a), $h(a, 0));
    }
    for (var s = 0; s < i; s++)
      for (var l = 0; l < r.length; l++) {
        var u = e[s][r[l]];
        t = t.replace($h(Kh[l], s), n ? $t(u) : u);
      }
    return t;
  }
  function Jh(t, e) {
  ...
  var tc = R,
    ec = ['left', 'right', 'top', 'bottom', 'width', 'height'],
    nc = [
      ['width', 'left', 'right'],
      ['height', 'top', 'bottom'],
    ];
  ...
  var lc = Qr(),
    uc = (function (t) {
      function e(e, n, i) {
        ...
        return (r.uid = hh('ec_cpt_model')), r;
      }
      return (
        n(e, t),
  ...
  uo(uc, lh),
    ...
    (function (t, e) {
      ...
      var e = [];
      R(uc.getClassesByMainType(t), function (t) {
  ...
  var hc = '';
  'undefined' != typeof navigator && (hc = navigator.platform || '');
  var cc = 'rgba(0, 0, 0, 0.2)',
    pc = {
      darkMode: 'auto',
      colorBy: 'series',
      color: [
  ...
  function kc(t, e, n) {
    ...
    var s = (function () {
      for (var t = {}, i = {}, s = [], l = 0, u = Math.min(5, n); l < u; l++) {
        var h = Ac(e.data, o, e.seriesLayoutBy, a, e.startIndex, l);
        s.push(h);
        var c = h === Mc;
        if (
          (c && null == t.v && l !== r && (t.v = l),
          (null == t.n || t.n === t.v || (!c && s[t.n] === Mc)) && (t.n = l),
          p(t) && s[t.n] !== Mc)
        )
          return t;
        c ||
          (h === Sc && null == i.v && l !== r && (i.v = l),
  ...
  function Ac(t, e, n, i, r, o) {
    ...
    if (null != l) return 'ordinal' === l ? bc : Mc;
    if (e === gc) {
      var h = t;
      if (n === wc) {
    ...
    zc = (function () {
      ...
      return (
        (t.prototype.getColorFromPalette = function (t, e, n) {
          var i = Vr(this.get('color', !0)),
            r = this.get('colorLayer', !0);
          return Fc(this, Nc, i, r, t, e, n);
        }),
  ...
  function Bc(t, e, n, i) {
    var r = Vr(t.get(['aria', 'decal', 'decals']));
    return Fc(t, Ec, r, null, e, n, i);
  }
  ...
  var Hc = (function (t) {
    ...
    return (
      ...
      (e.prototype.init = function (t, e, n, i, r, o) {
        (i = i || {}),
          (this.option = null),
          (this._theme = new lh(i)),
          (this._locale = new lh(r)),
      ...
      (e.prototype.resetOption = function (t, e) {
        return this._resetOption(t, Uc(e));
      }),
      ...
      (e.prototype._mergeOption = function (t, e) {
        ...
        (Tc(this).datasetMap = ft()),
          ...
          s &&
            s.each(function (t, e) {
              uc.hasClass(e) && !a.get(e) && (o.push(e), a.set(e, !0));
            }),
          uc.topologicalTravel(
            o,
            uc.getAllClassMainTypes(),
            function (e) {
              ...
              R(
                ...
                function (t, n) {
                  ...
                  if (r) {
                    var o = 'series' === e,
                      a = uc.getClass(e, t.keyInfo.subType, !o);
                    if (!a) return;
                    if ('tooltip' === e) {
                      if (h) return void 0;
                      h = !0;
                    ...
                    if (i && i.constructor === a)
                      ...
                      var s = k({ componentIndex: n }, t.keyInfo);
                      k((i = new a(r, this, this, s)), s),
      ...
      (e.prototype.getOption = function () {
        ...
        return (
          R(t, function (e, n) {
            if (uc.hasClass(n)) {
              for (var i = Vr(e), r = i.length, o = !1, a = r - 1; a >= 0; a--)
                i[a] && !Kr(i[a]) ? (o = !0) : ((i[a] = null), !o && r--);
              (i.length = r), (t[n] = i);
            }
          }),
          delete t[Vc],
      ...
      (e.prototype.findComponents = function (t) {
        ...
        return (o = Gc(u, t)), t.filter ? z(o, t.filter) : o;
      }),
      ...
      (e.prototype.isSeriesFiltered = function (t) {
        return Oc(this), null == this._seriesIndicesMap.get(t.componentIndex);
      }),
      ...
      (e.prototype.restoreData = function (t) {
        ...
        var e = this._componentsMap,
          n = [];
        e.each(function (t, e) {
          uc.hasClass(e) && n.push(e);
        }),
          uc.topologicalTravel(n, uc.getAllClassMainTypes(), function (n) {
  ...
  function Wc(t, e, n) {
    if (H(e)) {
      ...
      return (
        R(e, function (t) {
          null != t && null != Zr(t, null) && i.set(t, !0);
        }),
        z(n, function (e) {
          return e && i.get(e[t]);
        })
  ...
  function Uc(t) {
    ...
    return (
      t &&
        R(Vr(t.replaceMerge), function (t) {
          e.set(t, !0);
        }),
    ...
    Kc = (function () {
      ...
      return (
        (t.prototype.setOption = function (t, e, n) {
          t &&
            (R(Vr(t.series), function (t) {
              t && t.data && Z(t.data) && lt(t.data);
            }),
            R(Vr(t.dataset), function (t) {
  ...
  function np(t, e, n) {
    if (t && t[e] && (t[e].normal || t[e].emphasis)) {
      var i = t[e].normal,
        r = t[e].emphasis;
      i &&
        (n ? ((t[e].normal = t[e].emphasis = null), D(t[e], i)) : (t[e] = i)),
        r &&
          ((t.emphasis = t.emphasis || {}),
          (t.emphasis[e] = r),
  ...
  function op(t) {
    t && (ip(t), rp(t, 'label'), t.emphasis && rp(t.emphasis, 'label'));
  }
  function ap(t) {
    return H(t) ? t : t ? [t] : [];
  }
  ...
  function lp(t, e) {
        ...
        (function (t) {
          if (Jc(t)) {
            ep(t),
              ...
              t.emphasis &&
                (rp(t.emphasis, 'label'),
                rp(t.emphasis, 'upperLabel'),
                rp(t.emphasis, 'edgeLabel'));
            var e = t.markPoint;
            e && (ep(e), op(e));
            var n = t.markLine;
            n && (ep(n), op(n));
            ...
            if ('graph' === t.type) {
              ...
              if (o && !Z(o)) for (var a = 0; a < o.length; a++) op(o[a]);
              R(t.categories, function (t) {
                ip(t);
              });
            }
            if (r && !Z(r)) for (a = 0; a < r.length; a++) op(r[a]);
            if ((e = t.markPoint) && e.data) {
              var s = e.data;
              for (a = 0; a < s.length; a++) op(s[a]);
            }
            if ((n = t.markLine) && n.data) {
              var l = n.data;
              for (a = 0; a < l.length; a++)
                H(l[a]) ? (op(l[a][0]), op(l[a][1])) : op(l[a]);
            }
            'gauge' === t.type
              ? (rp(t, 'axisLabel'), rp(t, 'title'), rp(t, 'detail'))
              : 'treemap' === t.type
                ? (np(t.breadcrumb, 'itemStyle'),
                  R(t.levels, function (t) {
                    ip(t);
                  }))
                : 'tree' === t.type && ip(t.leaves);
          }
        })(t);
    });
    var n = [
    ...
    e && n.push('valueAxis', 'categoryAxis', 'logAxis', 'timeAxis'),
      Qc(n, function (e) {
        Qc(ap(t[e]), function (t) {
          t && (rp(t, 'axisLabel'), rp(t.axisPointer, 'label'));
        });
      }),
      Qc(ap(t.parallel), function (t) {
        var e = t && t.parallelAxisDefault;
        rp(e, 'axisLabel'), rp(e && e.axisPointer, 'label');
      }),
      Qc(ap(t.calendar), function (t) {
        np(t, 'itemStyle'),
          rp(t, 'dayLabel'),
          rp(t, 'monthLabel'),
          rp(t, 'yearLabel');
      }),
      Qc(ap(t.radar), function (t) {
        rp(t, 'name'),
          t.name &&
            null == t.axisName &&
      ...
      Qc(ap(t.geo), function (t) {
        Jc(t) &&
          (op(t),
          Qc(ap(t.regions), function (t) {
            op(t);
          }));
      }),
      Qc(ap(t.timeline), function (t) {
        op(t), np(t, 'label'), np(t, 'itemStyle'), np(t, 'controlStyle', !0);
        var e = t.data;
        H(e) &&
          R(e, function (t) {
            Y(t) && (np(t, 'label'), np(t, 'itemStyle'));
          });
      }),
      Qc(ap(t.toolbox), function (t) {
        np(t, 'iconStyle'),
          Qc(t.feature, function (t) {
            np(t, 'iconStyle');
          });
      }),
      rp(sp(t.axisPointer), 'label'),
      rp(sp(t.tooltip).axisPointer, 'label');
  }
  function up(t) {
    t &&
      R(hp, function (e) {
  ...
  function yp(t, e) {
    if (t)
      for (var n = 0; n < t.length; n++) e(t[n]), t[n] && yp(t[n].children, e);
  }
  function vp(t, e) {
    lp(t, e),
      (t.series = Vr(t.series)),
        ...
        if (Y(t)) {
          ...
          if ('line' === e) null != t.clipOverflow && (t.clip = t.clipOverflow);
            ...
            if (
              ...
              for (var n = 0; n < r.length; n++) dp(r[n]);
            null != t.hoverOffset &&
              ((t.emphasis = t.emphasis || {}),
            ...
            if (
              (fp(t),
              fp(t.backgroundStyle),
              fp(t.emphasis),
              (r = t.data) && !Z(r))
            )
              for (n = 0; n < r.length; n++)
                'object' == typeof r[n] &&
                  (fp(r[n]), fp(r[n] && r[n].emphasis));
          } else if ('sunburst' === e) {
            ...
            'graph' === e || 'sankey' === e
              ...
              : 'map' === e &&
                ...
                t.mapLocation && D(t, t.mapLocation));
  ...
  var _p,
    ...
    Sp,
    Mp = function (t) {
      (this.data = t.data || (t.sourceFormat === vc ? {} : [])),
        (this.sourceFormat = t.sourceFormat || _c),
        (this.seriesLayoutBy = t.seriesLayoutBy || xc),
      ...
      if (e)
        for (var n = 0; n < e.length; n++) {
          var i = e[n];
          null == i.type && Ic(this, n) === bc && (i.type = 'ordinal');
        }
    };
  function Tp(t) {
  ...
  function kp(t) {
    return new Mp({ data: t, sourceFormat: Z(t) ? mc : dc });
  }
  function Dp(t) {
    var e = _c;
    if (Z(t)) e = mc;
  ...
  var Pp = (function () {
    ...
    Rp =
      (((_p = {})[gc + '_' + xc] = function (t, e, n, i) {
        return t[i + e];
      }),
      (_p[gc + '_' + wc] = function (t, e, n, i, r) {
        i += e;
  ...
  var Ep = function (t, e, n) {
    ...
    zp =
      (((xp = {})[gc + '_' + xc] = function (t, e, n) {
        return Math.max(0, t.length - e);
      }),
      (xp[gc + '_' + wc] = function (t, e, n) {
        var i = t[0];
        return i ? Math.max(0, i.length - e) : 0;
      }),
      (xp[yc] = Ep),
      (xp[vc] = function (t, e, n) {
        var i = n[0].name;
        var r = t[i];
        return r ? r.length : 0;
      }),
  ...
  var Fp = function (t, e, n) {
    ...
    Vp =
      (((wp = {})[gc] = Fp),
      (wp[yc] = function (t, e, n) {
        return t[n];
      }),
      (wp[vc] = Fp),
      (wp[dc] = function (t, e, n) {
        var i = Gr(t);
      ...
      return (
        ...
        (t.prototype.getFormattedLabel = function (t, e, n, i, r, o) {
          ...
          return W(r)
            ...
            : G(r)
              ? Qh(r, s).replace(Up, function (e, n) {
                  var i = n.length,
                    r = n;
                  '[' === r.charAt(0) &&
                    ']' === r.charAt(i - 1) &&
        ...
        (t.prototype._doProgress = function (t, e, n, i, r) {
          Zp.reset(e, n, i, r),
            ...
            this._callingProgress(
              { start: e, end: n, count: n - e, next: Zp.next },
              this.context,
            );
        }),
  ...
  function Qp(t) {
    ...
    if (e === yc) {
      for (r = [], o = 0, a = n.length; o < a; o++) r.push(k({}, n[o]));
      return r;
    }
  }
  function Jp(t, e, n) {
  ...
  function nf(t, e, n, i) {
    ...
    var s = N(e, function (t) {
        return (function (t, e) {
          ...
          e.__isBuiltIn &&
            ...
            (n.getRawData = F($p, null, t))),
            (n.cloneRawData = F(Qp, null, t));
          var p = Bp(r, xc);
          ...
          return (
            (n.getDimensionInfo = F(Jp, null, s, l)),
            (n.cloneAllDimensionInfo = F(tf, null, s)),
            n
          );
        })(t, a);
      }),
    ...
    return N(l, function (t, n) {
      var i,
        r = '';
      Y(t) || zr(r), t.data || zr(r), rf(Dp(t.data)) || zr(r);
      var o = e[0];
      if (o && 0 === n && !t.dimensions) {
        ...
        i = { seriesLayoutBy: xc, sourceHeader: 0, dimensions: t.dimensions };
      return Cp(t.data, i, null);
    });
  }
  function rf(t) {
    return t === gc || t === yc;
  ...
  var of,
    af = 'undefined',
    sf = typeof Uint32Array === af ? Array : Uint32Array,
    lf = typeof Uint16Array === af ? Array : Uint16Array,
    uf = typeof Int32Array === af ? Array : Int32Array,
    hf = typeof Float64Array === af ? Array : Float64Array,
    cf = { float: hf, int: uf, ordinal: Array, number: Array, time: hf };
  function pf(t) {
    return t > 65535 ? sf : lf;
  }
  ...
  var df = (function () {
      ...
      return (
        (t.prototype.initData = function (t, e, n) {
          ...
          var i = t.getSource(),
            r = (this.defaultDimValueGetter = of[i.sourceFormat]);
        ...
        (t.prototype.ensureCalculationDimension = function (t, e) {
          ...
          return (
            (i[r] = { type: e }),
            n.set(t, r),
            (this._chunks[r] = new cf[e || 'float'](this._rawCount)),
        ...
        (t.prototype.appendValues = function (t, e) {
          for (
            ...
            ff(n, l, (f = i[l]).type, s, !0);
          }
          for (var u = [], h = a; h < s; h++)
            for (var c = h - a, p = 0; p < r; p++) {
              var f = i[p],
                d = of.arrayRows.call(this, t[c] || u, f.property, c, p);
              n[p][h] = d;
              var g = o[p];
        ...
        (t.prototype._initDataFromProvider = function (t, e, n) {
          for (
            ...
            var h = o[u];
            s[u] || (s[u] = [1 / 0, -1 / 0]), ff(r, u, h.type, e, n);
          }
        ...
        (t.prototype.getIndices = function () {
          ...
          if (e) {
            ...
            t = new (n = pf(this._rawCount))(this.count());
        ...
        (t.prototype.downSample = function (t, e, n, i) {
          for (
            var r = this.clone([t], !0),
              ...
              c = new (pf(this._rawCount))(Math.ceil(u / s)),
              p = 0,
              f = 0;
            f < u;
            f += s
        ...
        (t.internalField = (function () {
          function t(t, e, n, i) {
            return jp(t[i], this._dimensions[i]);
          }
          of = {
            arrayRows: t,
            objectRows: function (t, e, n, i) {
              return jp(t[e], this._dimensions[i]);
            },
            keyedColumns: t,
            original: function (t, e, n, i) {
              var r = t && (null == t.value ? t : t.value);
              return jp(r instanceof Array ? r[i] : r, this._dimensions[i]);
            },
      ...
      return (
          ...
          if (vf(n)) {
            ...
            if (r) {
              ...
              u.prepareSource(),
                ...
                (s = l.sourceFormat),
                (e = [u._getVersionSign()]);
            } else (s = Z((a = o.get('data', !0))) ? mc : dc), (e = []);
            ...
            if (r) {
              ...
              (t = [
                Cp(g.get('source', !0), this._getSourceMetaRawOption(), null),
              ]),
                (e = []);
            }
          }
          ...
          return (
            R(t, function (t) {
              ...
              var e = t.getSource(r || 0),
                n = '';
              null == r || e || mf(n), s.push(e), l.push(t._getVersionSign());
            }),
            i
              ? (e = (function (t, e, n) {
                  var i = Vr(t),
        ...
        (t.prototype._innerGetDataStore = function (t, e, n) {
          ...
          if (!o) {
            ...
            vf(this._sourceHost) && a
              ? (o = a._innerGetDataStore(t, e, n))
              : (o = new df()).initData(new Pp(e, t.length), t),
              (r[n] = o);
          }
          return o;
        }),
  ...
  function xf(t) {
    var e,
      ...
      p = H(c),
      f = (function (t, e) {
        return Jh(t.getData().getItemVisual(e, 'style')[t.visualDrawType]);
      })(o, a);
    if (h > 1 || (p && !h)) {
    ...
    return (
      ...
      (e.prototype.init = function (t, e, n) {
        (this.seriesIndex = this.componentIndex),
          (this.dataTask = Yp({ count: Tf, reset: Cf })),
          (this.dataTask.context = { model: this }),
          this.mergeDefaultAndTheme(t, n),
          (wf(this).sourceManager = new gf(this)).prepareSource();
        var i = this.getInitialData(t, n);
        Df(i, this),
          (this.dataTask.context.data = i),
          (wf(this).dataBeforeProcessed = i),
          Mf(this),
      ...
      (e.prototype.getData = function (t) {
        ...
        if (e) {
          ...
          return null != t && n.getLinkedData ? n.getLinkedData(t) : n;
        }
        return wf(this).data;
      }),
      ...
      (e.prototype.getSourceManager = function () {
        return wf(this).sourceManager;
      }),
      (e.prototype.getSource = function () {
        return this.getSourceManager().getSource();
      }),
      (e.prototype.getRawData = function () {
        return wf(this).dataBeforeProcessed;
      }),
      ...
      (e.prototype.getColorFromPalette = function (t, e, n) {
        var i = this.ecModel,
          r = zc.prototype.getColorFromPalette.call(this, t, e, n);
  ...
  function Cf(t) {
    var e = t.model;
    return e.setData(e.getRawData().cloneShallow()), kf;
  }
  function kf(t, e) {
    e.outputData &&
  ...
  P(Sf, Xp), P(Sf, zc), uo(Sf, uc);
  var Lf = (function () {
    function t() {
      (this.group = new sr()), (this.uid = hh('viewComponent'));
    }
    return (
  ...
  var Of = Qr(),
    ...
    Nf = (function () {
      function t() {
        (this.group = new sr()),
          (this.uid = hh('viewChart')),
          (this.renderTask = Yp({ plan: Bf, reset: Ff })),
    ...
    var i = $r(t, e),
      r =
        e && null != e.highlightKey
          ? (function (t) {
              var e = gs[t];
              return null == e && ds <= 32 && (e = gs[t] = ds++), e;
            })(e.highlightKey)
          : null;
    null != i
      ? R(Vr(i), function (e) {
          Ef(t.getItemGraphicEl(e), n, r);
        })
  ...
  function Ff(t) {
    var e = t.model,
      ...
      a = t.view,
      s = r && Of(r).updateMethod,
      l = o ? 'incrementalPrepareRender' : s && a[s] ? s : 'render';
    return 'render' !== l && a[l](e, n, i, r), Vf[l];
  }
  lo(Nf), fo(Nf);
  var Vf = {
  ...
  var Wf = Qr(),
    Gf = { itemStyle: go(oh, !0), lineStyle: go(nh, !0) },
    Uf = { lineStyle: 'stroke', itemStyle: 'fill' };
  function Xf(t, e) {
    var n = t.visualStyleMapper || Gf[e];
    return n || (console.warn("Unknown style type '" + e + "'."), Gf.itemStyle);
  }
  function Yf(t, e) {
    var n = t.visualDrawType || Uf[e];
            ...
            dataEach: n.hasItemOption
              ? function (t, e) {
                  ...
                  if (n && n[i]) {
                    Zf.option = n[i];
                    var a = r(Zf);
                    k(t.ensureUniqueItemVisual(e, 'style'), a),
                      Zf.option.decal &&
                        (t.setItemVisual(e, 'decal', Zf.option.decal),
                        (Zf.option.decal.dirty = !0)),
  ...
  var Qf = (function () {
    ...
    return (
      ...
      (t.prototype._createSeriesStageTask = function (t, e, n, i) {
        ...
        function u(e) {
          var s = e.uid,
            l = a.set(
              s,
              (o && o.get(s)) || Yp({ plan: id, reset: rd, count: sd }),
            );
          (l.context = {
            model: e,
            ecModel: n,
      ...
      (t.prototype._createOverallStageTask = function (t, e, n, i) {
        var r = this,
          o = (e.overallTask = e.overallTask || Yp({ reset: Jf }));
        o.context = {
          ecModel: n,
          api: i,
        ...
        function f(t) {
          var e = t.uid,
            n = s.set(
              e,
              (a && a.get(e)) || ((c = !0), Yp({ reset: td, onDirty: nd })),
            );
      ...
      (t.wrapStageHandler = function (t, e) {
        return (
          W(t) && (t = { overallReset: t, seriesType: ld(t) }),
          (t.uid = hh('stageHandler')),
          e && (t.visualType = e),
          t
        );
      }),
  ...
  pd(hd, Hc),
    ...
    (hd.eachComponent = function (t) {
      'series' === t.mainType && t.subType && (ud = t.subType);
    });
  var fd = [
      '#37A2DA',
      '#32C5E9',
    ...
    _d = {
      ...
      legend: { textStyle: { color: gd } },
      textStyle: { color: gd },
      title: {
        textStyle: { color: '#EEF1FA' },
        subtextStyle: { color: '#B9B8CE' },
      },
      toolbox: { iconStyle: { borderColor: gd } },
      dataZoom: {
        borderColor: '#71708A',
        textStyle: { color: gd },
      ...
      visualMap: { textStyle: { color: gd } },
      timeline: {
        lineStyle: { color: gd },
        label: { color: gd },
        controlStyle: { color: gd, borderColor: gd },
      },
      calendar: {
        itemStyle: { color: yd },
        dayLabel: { color: gd },
  ...
  _d.categoryAxis.splitLine.show = !1;
  var xd = (function () {
      function t() {}
      return (
    ...
    wd = ['symbol', 'symbolSize', 'symbolRotate', 'symbolOffset'],
    bd = wd.concat(['symbolKeepAspect']),
    Sd = {
      createOnAllSeries: !0,
      performRawSeries: !0,
      reset: function (t, e) {
        ...
        if (
          ...
          for (var i = {}, r = {}, o = !1, a = 0; a < wd.length; a++) {
            var s = wd[a],
              l = t.get(s);
            W(l) ? ((o = !0), (r[s] = l)) : (i[s] = l);
          }
        ...
        if (t.hasSymbolVisual && !e.isSeriesFiltered(t))
          return {
            dataEach: t.getData().hasItemOption
              ? function (t, e) {
                  for (var n = t.getItemModel(e), i = 0; i < bd.length; i++) {
                    var r = bd[i],
                      o = n.getShallow(r, !0);
  ...
  var kd = Math.round(9 * Math.random()),
    Dd = 'function' == typeof Object.defineProperty,
    Id = (function () {
      function t() {
        this._id = '__ec_inner_' + kd++;
      }
      return (
        (t.prototype.get = function (t) {
  ...
  var Ed = Ha.extend({
    ...
    buildPath: function (t, e, n) {
      ...
      if ('none' !== i) {
        var r = Nd[i];
        r || (r = Nd[(i = 'rect')]),
          Rd[i](e.x, e.y, e.width, e.height, r.shape),
  ...
  function Bd(t, e, n, i, r, o, a) {
    ...
    return (
      ...
      ((s =
        0 === t.indexOf('image://')
          ? Lu(t.slice(8), new Ce(e, n, i, r), a ? 'center' : 'cover')
          : 0 === t.indexOf('path://')
            ? Au(t.slice(7), {}, new Ce(e, n, i, r), a ? 'center' : 'cover')
            : new Ed({
  ...
  function Fd(t, e) {
    if (null != t)
      return (
        H(t) || (t = [t, t]),
        [mr(t[0], e[0]) || 0, mr(et(t[1], t[0]), e[1]) || 0]
      );
  }
  function Vd(t) {
    return isFinite(t);
  ...
  var Qd = ['shadowBlur', 'shadowOffsetX', 'shadowOffsetY'],
    Jd = [
      ['lineCap', 'butt'],
      ['lineJoin', 'miter'],
      ['miterLimit', 10],
  ...
  function tg(t, e, n, i, r) {
    ...
    if (i || e.opacity !== n.opacity) {
      ...
      t.globalAlpha = isNaN(a) ? Eo.opacity : a;
    }
    (i || e.blend !== n.blend) &&
      (o || (ig(t, r), (o = !0)),
      (t.globalCompositeOperation = e.blend || Eo.blend));
    ...
    return (
      (i || e.shadowColor !== n.shadowColor) &&
        (o || (ig(t, r), (o = !0)),
        (t.shadowColor = e.shadowColor || Eo.shadowColor)),
      o
    );
  }
  function eg(t, e, n, i, r) {
    var o = rg(e, r.inHover),
      a = i ? null : (n && rg(n, r.inHover)) || {};
    if (o === a) return !1;
    var s = tg(t, o, a, i, r);
    if (
      ((i || o.fill !== a.fill) &&
        (s || (ig(t, r), (s = !0)), qd(o.fill) && (t.fillStyle = o.fill)),
      (i || o.stroke !== a.stroke) &&
        (s || (ig(t, r), (s = !0)), qd(o.stroke) && (t.strokeStyle = o.stroke)),
    ...
    for (var u = 0; u < Jd.length; u++) {
      var h = Jd[u],
        c = h[0];
      (i || o[c] !== a[c]) &&
        (s || (ig(t, r), (s = !0)), (t[c] = o[c] || h[1]));
    }
    return s;
  }
  function ng(t, e) {
  ...
  function og(t, e) {
    ag(t, e, { inHover: !1, viewWidth: 0, viewHeight: 0 }, !0);
  }
  function ag(t, e, n, i) {
    var r = e.transform;
          ...
          (function (t, e, n, i) {
            ...
            if (!i) {
              ...
              (d || g) && (b = e.getBoundingRect()),
                d &&
                  ((m = c ? Hd(t, p, b) : e.__canvasFillGradient),
                  (e.__canvasFillGradient = m)),
                g &&
                  ((_ = c ? Hd(t, f, b) : e.__canvasStrokeGradient),
            ...
            h.setScale(T[0], T[1], e.segmentIgnoreThreshold),
              t.setLineDash && n.lineDash && ((S = (r = Ud(e))[0]), (M = r[1]));
            var C = !0;
            (u || 4 & c) &&
              (h.setDPR(t.dpr),
        ...
        : e instanceof Ga
            ...
            (function (t, e, n) {
              ...
              if ((null != r && (r += ''), r)) {
                ...
                t.setLineDash &&
                  ...
                  n.strokeFirst
                    ? (Yd(n) && t.strokeText(r, n.x, n.y),
                      Zd(n) && t.fillText(r, n.x, n.y))
                    : (Zd(n) && t.fillText(r, n.x, n.y),
                      Yd(n) && t.strokeText(r, n.x, n.y)),
                  a && t.setLineDash([]);
              }
          ...
          : e instanceof Ya
            ? (2 !== n.lastDrawType && ((u = !0), (n.lastDrawType = 2)),
              (function (t, e, n, i, r) {
                tg(t, rg(e, r.inHover), n && rg(n, r.inHover), i, r);
              })(t, e, h, u, n),
              (function (t, e, n) {
                var i = (e.__image = xo(n.image, e.__image, e, e.onload));
                if (i && bo(i)) {
                  var r = n.x || 0,
                    o = n.y || 0,
                    a = e.getWidth(),
  ...
  function hg(t, e) {
    ...
    return (
      (function (t) {
        for (var e, o = [n], s = !0, l = 0; l < ug.length; ++l) {
          var h = a[ug[l]];
        ...
        var p,
          ...
          x = (function () {
            for (var t = 1, e = 0, n = y.length; e < n; ++e) t = Nr(t, y[e]);
            var i = 1;
            for (e = 0, n = g.length; e < n; ++e) i = Nr(i, g[e].length);
            t *= i;
  ...
  var vg = 2e3,
    ...
    xg = '__flagInMainProcess',
    wg = '__pendingUpdate',
    bg = '__needsUpdateStatus',
    Sg = /^[a-zA-Z0-9_]+$/,
    Mg = '__connectUpdateStatus';
  function Tg(t) {
    return function () {
      for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
      if (!this.isDisposed()) return kg(this, t, e);
      $g(this.id);
    };
  }
  function Cg(t) {
  ...
  var Dg,
    ...
    qg = Yg.prototype;
  (qg.on = Cg('on')), (qg.off = Cg('off'));
  var Zg = (function (t) {
      function e(e, n, i) {
        var r = t.call(this, new xd()) || this;
        (r._chartsViews = []),
          (r._chartsMap = {}),
          (r._componentsViews = []),
          (r._componentsMap = {}),
        ...
        (r._ssr = i.ssr),
          (r._throttledZrFlush = Hf(F(l.flush, l), 17)),
          (n = T(n)) && vp(n, !0),
          (r._theme = n),
          (r._locale = (function (t) {
            if (G(t)) {
              var e = dh[t.toUpperCase()] || {};
              return t === ch || t === ph ? T(e) : C(T(e), T(dh[fh]), !1);
            }
            return C(T(t), T(dh[fh]), !1);
          })(i.locale || yh)),
          (r._coordSysMgr = new Zc());
        var u = (r._api = Wg(r));
        function h(t, e) {
        ...
        return (
          We(ny, h),
          We(ty, h),
          (r._scheduler = new Qf(r, u, ty, ny)),
          (r._messageCenter = new Yg()),
          r._initEvents(),
      ...
      return (
        ...
        (e.prototype._onframe = function () {
          if (!this._disposed) {
            ...
            if (this[wg]) {
              var e = this[wg].silent;
              this[xg] = !0;
              try {
                Dg(this), Lg.update.call(this, null, this[wg].updateParams);
              } catch (t) {
                throw ((this[xg] = !1), (this[wg] = null), t);
              }
              this._zr.flush(),
                (this[xg] = !1),
                (this[wg] = null),
          ...
          if (!this[xg])
            if (this._disposed) $g(this.id);
              ...
              if (
                ...
                var a = new Kc(this._api),
                  s = this._theme,
                  l = (this._model = new Hc());
                (l.scheduler = this._scheduler),
                  (l.ssr = this._ssr),
                  l.init(null, null, null, s, this._locale, a);
              }
              this._model.setOption(t, { replaceMerge: r }, ey);
              var u = { seriesTransition: o, optionChanged: !0 };
              if (n)
                (this[wg] = { silent: i, updateParams: u }),
                  (this[xg] = !1),
                  this.getZr().wakeUp();
              else {
                try {
                  Dg(this), Lg.update.call(this, null, u);
                } catch (t) {
                  throw ((this[wg] = null), (this[xg] = !1), t);
                }
        ...
        (e.prototype.convertToPixel = function (t, e) {
          return Pg(this, 'convertToPixel', t, e);
        }),
        (e.prototype.convertFromPixel = function (t, e) {
          return Pg(this, 'convertFromPixel', t, e);
        }),
        ...
        (e.prototype.getVisual = function (t, e) {
          var n = to(this._model, t, { defaultMainType: 'series' }),
            i = n.seriesModel;
          var r = i.getData(),
        ...
        (e.prototype._initEvents = function () {
          ...
          R(Kg, function (t) {
                  ...
                  : o &&
                    Cd(
                      ...
                      function (t) {
                        ...
                        if (e.eventData) return (n = k({}, e.eventData)), !0;
                      },
                      !0,
                    ),
                n)
            ...
            t.on('selectchanged', function (t) {
              var i = n.getModel();
              t.isFromClick
                ? (Td('map', 'selectchanged', e, i, t),
                  Td('pie', 'selectchanged', e, i, t))
                : 'select' === t.fromAction
                  ? (Td('map', 'selected', e, i, t),
                    Td('pie', 'selected', e, i, t))
                  : 'unselect' === t.fromAction &&
                    (Td('map', 'unselected', e, i, t),
                    Td('pie', 'unselected', e, i, t));
            });
        }),
        ...
        (e.prototype.clear = function () {
          this._disposed ? $g(this.id) : this.setOption({ series: [] }, !0);
        }),
        (e.prototype.dispose = function () {
          if (this._disposed) $g(this.id);
          else {
            (this._disposed = !0), this.getDom() && ro(this.getDom(), uy, '');
            var t = this,
              e = t._api,
              n = t._model;
              ...
              if ((this._loadingFX && this._loadingFX.resize(), e)) {
                ...
                try {
                  n && Dg(this),
                    Lg.update.call(this, {
                      type: 'resize',
                      animation: k({ duration: 0 }, t && t.animation),
                    });
                } catch (t) {
                  throw ((this[xg] = !1), t);
                }
                (this[xg] = !1), Ng.call(this, i), Eg.call(this, i);
              }
            }
        }),
        ...
        (e.prototype.makeActionFromEvent = function (t) {
          var e = k({}, t);
          return (e.type = Jg[t.type]), e;
        }),
        (e.prototype.dispatchAction = function (t, e) {
          if (this._disposed) $g(this.id);
          else if ((Y(e) || (e = { silent: !!e }), Qg[t.type] && this._model))
            if (this[xg]) this._pendingActions.push(t);
            else {
              var n = e.silent;
              Rg.call(this, t, n);
              var i = e.flush;
        ...
        (e.prototype.updateLabelLayout = function () {
          dg.trigger('series:layoutlabels', this._model, this._api, {
            updatedSeries: [],
          });
        }),
        (e.prototype.appendData = function (t) {
          ...
          (Dg = function (t) {
            ...
            (Ig = function (t, e) {
              ...
              function u(t) {
                ...
                if (!h) {
                  var c = so(t.type),
                    p = e ? Lf.getClass(c.main, c.sub) : Nf.getClass(c.sub);
                  0,
                    (h = new p()).init(n, s),
                    (o[u] = h),
                    r.push(h),
                          ...
                          if (al(n))
                            if (e instanceof Sf)
                              ...
                              n.type === xs &&
                                r &&
                                !n.notBlur &&
                                Zs(e.mainType, e.componentIndex, t._api),
                                o &&
                                  R(o, function (t) {
                                    n.type === xs ? Vs(t) : Hs(t);
                                  });
            ...
            (Lg = {
              ...
              updateView: function (e) {
                ...
                n &&
                  ...
                  Nf.markUpdateMethod(e, 'updateView'),
                  t(n),
                  this._scheduler.performVisualTasks(n, e, { setDirty: !0 }),
                  Fg(this, n, this._api, e, {}),
                  dg.trigger('afterupdate', n, this._api));
              },
              updateVisual: function (e) {
                ...
                i &&
                  ...
                  Nf.markUpdateMethod(e, 'updateVisual'),
                  t(i),
                  this._scheduler.performVisualTasks(i, e, {
                    visualType: 'visual',
                    setDirty: !0,
                  ...
                  dg.trigger('afterupdate', i, this._api));
              },
            ...
            (Rg = function (t, e) {
              ...
              if (
                ...
                R(c, function (e) {
                  if (
                    (((f =
                      (f = a.action(e, n._model, n._api)) || k({}, e)).type =
                      s.event || f.type),
                    d.push(f),
                    y)
                  ) {
                    ...
                    g
                      ? (Ag(n, u, e, 'series'), Ug(n))
                      : h && Ag(n, u, e, h.main, h.sub);
                }),
                'none' !== u && !y && !g && !h)
              )
                try {
                  this[wg]
                    ? (Dg(this), Lg.update.call(this, t), (this[wg] = null))
                    : Lg[u].call(this, t);
                } catch (t) {
                  throw ((this[xg] = !1), t);
                }
                ...
                n &&
                  (!(function (t, e, n) {
                    var i = fs(t),
                      ...
                      a = r.focusSelf;
                    o
                      ? (a && Zs(i.componentMainType, i.componentIndex, n),
                        R(o, function (t) {
                          return Bs(t, e);
                        }))
                      : (qs(i.seriesIndex, i.focus, i.blurScope, n),
                        'self' === i.focus &&
                          Zs(i.componentMainType, i.componentIndex, n),
                        Bs(t, e));
                  })(n, t, e._api),
                  Ug(e));
              })
            ...
            (Vg = function (t, e, n, r, o, l) {
              R(l || t._componentsViews, function (t) {
                var o = t.__model;
                a(o, t), t.render(o, e, n, r), i(o, t), s(o, t);
              });
            }),
            (Hg = function (t, e, n, o, l, u) {
              var h = t._scheduler;
              (l = k(l || {}, { updatedSeries: e.getSeries() })),
                dg.trigger('series:beforeupdate', e, n, l);
              var c = !1;
              e.eachSeries(function (e) {
                ...
                dg.trigger('series:layoutlabels', e, n, l),
                dg.trigger('series:transition', e, n, l),
                e.eachSeries(function (e) {
                  var n = t._chartsMap[e.__viewId];
                  i(e, n), s(e, n);
                }),
                ...
                dg.trigger('series:afterupdate', e, n, l);
            }),
            (Ug = function (t) {
              (t[bg] = !0), t.getZr().wakeUp();
            }),
            (Xg = function (t) {
              t[bg] &&
  ...
  function _y(t, e, n) {
    ...
    (t.event = (t.event || i).toLowerCase()),
      (e = t.event),
      Jg[e] ||
        (ot(Sg.test(i) && Sg.test(e)),
        Qg[i] || (Qg[i] = { action: n, actionInfo: t }),
        (Jg[e] = i));
  }
  function xy(t, e) {
    Zc.register(t, e);
  ...
  function wy(t, e) {
    My(ny, t, e, 1e3, 'layout');
  }
  function by(t, e) {
    My(ny, t, e, 3e3, 'visual');
  }
  var Sy = [];
  function My(t, e, n, i, r) {
    if (((W(e) || Y(e)) && ((n = e), (e = i)), !(A(Sy, n) >= 0))) {
      Sy.push(n);
      var o = Qf.wrapStageHandler(n, r);
  ...
  by(vg, qf),
        ...
        if (!t.isSeriesFiltered(n)) {
          ...
          i.hasItemVisual() &&
            i.each(function (t) {
              ...
              n && (i.ensureUniqueItemVisual(t, 'style').decal = hg(n, e));
            });
          var r = i.getVisual('decal');
          if (r) i.getVisual('style').decal = hg(r, e);
        }
      });
    }),
    dy(vp),
      ...
      return (
        ...
        e.showSpinner &&
          ((r = new ru({
            ...
            .animateShape(!0)
            .when(1e3, { endAngle: (3 * $f) / 2 })
            .start('circularInOut'),
          r
            .animateShape(!0)
            .when(1e3, { startAngle: (3 * $f) / 2 })
            .delay(300)
            .start('circularInOut'),
          n.add(r)),
        (n.resize = function () {
    ...
    _y({ type: xs, event: xs, update: xs }, mt),
    _y({ type: ws, event: ws, update: ws }, mt),
    _y({ type: bs, event: bs, update: bs }, mt),
    _y({ type: Ss, event: Ss, update: Ss }, mt),
    _y({ type: Ms, event: Ms, update: Ms }, mt),
    fy('light', dd),
    fy('dark', _d);
  var Dy = [],
    Iy = {
      registerPreprocessor: dy,
      registerProcessor: gy,
      registerPostInit: yy,
      registerPostUpdate: vy,
      registerUpdateLifecycle: my,
      registerAction: _y,
      registerCoordinateSystem: xy,
      registerLayout: wy,
      registerVisual: by,
      registerTransform: ky,
      registerLoading: Ty,
      registerMap: Cy,
      ...
      registerSubTypeDefaulter: function (t, e) {
        uc.registerSubTypeDefaulter(t, e);
      },
  ...
  function Ay(t) {
    H(t)
      ...
      : A(Dy, t) >= 0 ||
        (Dy.push(t), W(t) && (t = { install: t }), t.install(Iy));
  }
  function Ly(t) {
  ...
  var Oy = (function () {
      function t(t, e, n, i, r, o) {
        (this._old = t),
          (this._new = e),
          (this._oldKeyGetter = n || Py),
          (this._newKeyGetter = i || Py),
          (this.context = r),
  ...
  var Ey = function (t) {
    ...
    zy = Qr(),
    By = { float: 'f', int: 'i', ordinal: 'o', number: 'n', time: 't' },
    Fy = (function () {
      function t(t) {
      ...
      return (
        ...
        (t.prototype._updateDimOmitted = function (t) {
          (this._dimOmitted = t),
            t && (this._dimNameMap || (this._dimNameMap = Wy(this.source)));
        }),
  ...
  function Wy(t) {
    var e = zy(t);
    return e.dimNameMap || (e.dimNameMap = Hy(t.dimensionsDefine));
  }
  function Gy(t) {
    return t > 30;
  }
  var Uy,
    ...
    $y = Y,
    Qy = N,
    Jy = 'undefined' == typeof Int32Array ? Array : Int32Array,
    tv = [
      'hasItemOption',
      '_nameList',
      '_idList',
    ...
    nv = (function () {
      function t(t, e) {
        ...
        for (
          ...
          var h = n[u],
            c = G(h) ? new Ey({ name: h }) : h instanceof Ey ? h : new Ey(h),
            p = c.name;
          (c.type = c.type || 'float'),
      ...
      return (
        ...
        (t.prototype.initData = function (t, e, n) {
          var i,
            r = this;
          if ((t instanceof df && (i = t), !i)) {
            var o = this.dimensions,
              a = Tp(t) || O(t) ? new Pp(t, o.length) : t;
            i = new df();
            var s = Qy(o, function (t) {
                ...
                if (u) {
                  ...
                  (Ny(i, u)[h] = e),
                    l.isExtraCoord ||
                      ...
                      (Ny(s, u)[h] = t.getDimensionIndex(l.name))),
        ...
        (t.prototype.appendValues = function (t, e) {
          ...
          if ((this._updateOrdinalMeta(), e))
            for (var a = i; a < r; a++) {
              var s = a - i;
              (this._nameList[a] = e[s]), o && Ky(this, a);
            }
        }),
        ...
        (t.prototype._doInit = function (t, e) {
          if (!(t >= e)) {
            ...
            var i = this._nameList,
              r = this._idList;
            if (n.getSource().sourceFormat === dc && !n.pure)
              for (var o = [], a = t; a < e; a++) {
                var s = n.getItem(a, o);
                if (
                  (!this.hasItemOption && Ur(s) && (this.hasItemOption = !0), s)
                ) {
                  var l = s.name;
                  null == i[a] && null != l && (i[a] = Zr(l, null));
                  var u = s.id;
                  null == r[a] && null != u && (r[a] = Zr(u, null));
                }
              }
            if (this._shouldMakeIdFromName())
              for (a = t; a < e; a++) Ky(this, a);
            Uy(this);
          }
        }),
        ...
        (t.prototype.setCalculationInfo = function (t, e) {
          $y(t) ? k(this._calculationInfo, t) : (this._calculationInfo[t] = e);
        }),
        ...
        (t.prototype.each = function (t, e, n) {
          W(t) && ((n = e), (e = t), (t = []));
          var i = n || this,
            r = Qy(qy(t), this._getStoreDimIndex, this);
        ...
        (t.prototype.setVisual = function (t, e) {
          (this._visual = this._visual || {}),
            $y(t) ? k(this._visual, t) : (this._visual[t] = e);
        }),
          ...
          return (
            e ||
              (e = new t(
                this._schema
                  ? this._schema
                  : Qy(this.dimensions, this._getDimInfo, this),
                this.hostModel,
              )),
            Zy(e, this),
        ...
        (t.internalField =
          ((Uy = function (t) {
            ...
            R(e, function (n, i) {
              var r = t._dimInfos[i],
                ...
                a = t._store;
              if (o) {
                n = e[i] = new Jy(o.categories.length);
          ...
          (Yy = function (t, e, n) {
            return Zr(t._getCategory(e, n), null);
          }),
          (Xy = function (t, e) {
            var n = t._idList[e];
            return (
              null == n && null != t._idDimIdx && (n = Yy(t, t._idDimIdx, e)),
              null == n && (n = 'e\0\0' + e),
              n
            );
          }),
          ...
          (jy = function (e) {
            var n = new t(
              e._schema ? e._schema : Qy(e.dimensions, e._getDimInfo, e),
              e.hostModel,
            );
            return Zy(n, e), n;
          }),
          (Zy = function (t, e) {
            R(tv.concat(e.__wrappedMethods || []), function (n) {
              e.hasOwnProperty(n) && (t[n] = e[n]);
            }),
          ...
          void (Ky = function (t, e) {
            var n = t._nameList,
              ...
              s = i[e];
            if (
              (null == a && null != r && (n[e] = a = Yy(t, r, e)),
              null == s && null != o && (i[e] = s = Yy(t, o, e)),
              null == s && null != a)
            ) {
  ...
  function iv(t, e) {
    ...
    var n = (e = e || {}).coordDimensions || [],
      ...
      s = e.canOmitUnusedDimensions && Gy(a),
      l = i === t.dimensionsDefine,
      u = l ? Wy(t) : Hy(i),
      h = e.encodeDefine;
    !h && e.encodeDefaulter && (h = e.encodeDefaulter(t, a));
    for (var c = ft(h), p = new uf(a), f = 0; f < p.length; f++) p[f] = -1;
    function d(t) {
      var e = p[t];
      if (e < 0) {
        var n = i[t],
  ...
  var av = {
    cartesian2d: function (t, e, n, i) {
      var r = t.getReferringComponents('xAxis', no).models[0],
        o = t.getReferringComponents('yAxis', no).models[0];
      (e.coordSysDims = ['x', 'y']),
        n.set('x', r),
        n.set('y', o),
        sv(r) && (i.set('x', r), (e.firstCategoryDimIndex = 0)),
        sv(o) &&
          (i.set('y', o),
          null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = 1));
    },
    singleAxis: function (t, e, n, i) {
      var r = t.getReferringComponents('singleAxis', no).models[0];
      (e.coordSysDims = ['single']),
        n.set('single', r),
        sv(r) && (i.set('single', r), (e.firstCategoryDimIndex = 0));
    },
    polar: function (t, e, n, i) {
      var r = t.getReferringComponents('polar', no).models[0],
        o = r.findAxisModel('radiusAxis'),
        a = r.findAxisModel('angleAxis');
      (e.coordSysDims = ['radius', 'angle']),
        n.set('radius', o),
        n.set('angle', a),
        sv(o) && (i.set('radius', o), (e.firstCategoryDimIndex = 0)),
        sv(a) &&
          (i.set('angle', a),
          null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = 1));
    },
  ...
  function hv(t, e) {
    return uv(t, e) ? t.getCalculationInfo('stackResultDimension') : e;
  }
  function cv(t, e, n) {
    n = n || {};
    var i,
      ...
      o = !1;
    t ? ((o = !0), (i = kp(t))) : (o = (i = r.getSource()).sourceFormat === dc);
    var a = (function (t) {
      ...
      f = lv(e, { schema: h, store: p }),
      d = new nv(h, e);
    d.setCalculationInfo(f);
    var g =
      null != c &&
      (function (t) {
        if (t.sourceFormat === dc) {
          return !H(
            Gr(
              (function (t) {
                var e = 0;
  ...
  function vv(t, e, n, i) {
    ...
    var s = (r.intervalPrecision = _v(a));
    return (
      (function (t, e) {
        ...
        (r.niceTickExtent = [
          _r(Math.ceil(t[0] / a) * a, s),
          _r(Math.floor(t[1] / a) * a, s),
        ]),
        t,
      ),
      r
  ...
  var Mv = (function (t) {
    ...
    return (
      ...
      (e.prototype.contain = function (t) {
        return (
          wv((t = this.parse(t)), this._extent) &&
          null != this._ordinalMeta.categories[t]
        );
      }),
      (e.prototype.normalize = function (t) {
        return bv((t = this._getTickNumber(this.parse(t))), this._extent);
      }),
      (e.prototype.scale = function (t) {
        return (
          (t = Math.round(Sv(t, this._extent))), this.getRawOrdinalNumber(t)
        );
      }),
    ...
    Cv = (function (t) {
      ...
      return (
        ...
        (e.prototype.getTicks = function (t) {
          ...
          if (!e) return o;
          n[0] < i[0] &&
            (t ? o.push({ value: Tv(i[0] - e, r) }) : o.push({ value: n[0] }));
          for (
            var a = i[0];
            a <= i[1] &&
            (o.push({ value: a }),
            (a = Tv(a + e, r)) !== o[o.length - 1].value);
          ...
          return (
            n[1] > s &&
              (t ? o.push({ value: Tv(s + e, r) }) : o.push({ value: n[1] })),
            o
          );
        }),
        (e.prototype.getMinorTicks = function (t) {
        ...
        (e.prototype.calcNiceExtent = function (t) {
          ...
          t.fixMin || (e[0] = Tv(Math.floor(e[0] / r) * r)),
            t.fixMax || (e[1] = Tv(Math.ceil(e[1] / r) * r));
        }),
  ...
  pv.registerClass(Cv);
  var kv = 'undefined' != typeof Float32Array,
    Dv = kv ? Float32Array : Array;
  function Iv(t) {
    return H(t) ? (kv ? new Float32Array(t) : t) : new Dv(t);
  }
  function Av(t) {
  ...
  function Ov(t) {
    ...
    return (
      R(t, function (t) {
        ...
        var p = mr(t.get('barWidth'), i),
          f = mr(t.get('barMaxWidth'), i),
          d = mr(t.get('barMinWidth') || (Ev(t) ? 0.5 : 1), i),
          g = t.get('barGap'),
      ...
      return (
        ...
        (e.prototype.getFormattedLabel = function (t, e, n) {
          ...
          return (function (t, e, n, i, r) {
            ...
            if (G(n)) o = n;
              ...
              if (t.level > 0)
                for (var s = 0; s < Ch.length; ++s)
                  a[Ch[s]] = '{primary|' + a[Ch[s]] + '}';
              var l = n ? (!1 === n.inherit ? n : D(n, a)) : a,
                u = Ph(t.value, r);
              if (l[u]) o = l[u];
              else if (l.inherit) {
                for (s = kh.indexOf(u) - 1; s >= 0; --s)
                  if (l[u]) {
                    o = l[u];
                    break;
                  }
            ...
            return Lh(new Date(t.value), o, r, i);
                ...
                if (
                  ...
                  for (var u = 0; u < r.length - 1; u++) {
                    ...
                    if (h !== c) {
                      ...
                      switch (t) {
                        case 'year':
                          (p = Math.max(1, Math.round(e / wh / 365))),
                            (f = Rh(n)),
                            (d = Hh(n));
                          break;
                        case 'half-year':
                        case 'quarter':
                        case 'month':
                          (p = Vv(e)), (f = Nh(n)), (d = Wh(n));
                          break;
                        case 'week':
                        case 'half-week':
                        case 'day':
                          (p = Fv(e)), (f = Eh(n)), (d = Gh(n)), (g = !0);
                          break;
                        case 'half-day':
                        case 'quarter-day':
                        case 'hour':
                          (p = Hv(e)), (f = zh(n)), (d = Uh(n));
                          break;
                        case 'minute':
                          (p = Wv(e, !0)), (f = Bh(n)), (d = Xh(n));
                          break;
                        case 'second':
                          (p = Wv(e, !1)), (f = Fh(n)), (d = Yh(n));
                          break;
                        case 'millisecond':
                          (p = Gv(e)), (f = Vh(n)), (d = qh(n));
                      }
                      s(p, h, c, f, d, g, a),
                        'year' === t &&
                          o.length > 1 &&
          ...
          var o = Bv.length,
            a = Math.min(
              (function (t, e, n, i) {
                ...
                return n;
              })(Bv, this._approxInterval, 0, o),
              o - 1,
            );
          (this._interval = Bv[a][1]),
            (this._minLevelUnit = Bv[Math.max(a - 1, 0)][0]);
        }),
        (e.prototype.parse = function (t) {
          return X(t) ? t : +Dr(t);
        }),
        ...
        (e.prototype.normalize = function (t) {
          return bv(this.parse(t), this._extent);
        }),
        (e.prototype.scale = function (t) {
          return Sv(t, this._extent);
        }),
  ...
  function Fv(t, e) {
    return (t /= wh) > 16 ? 16 : t > 7.5 ? 7 : t > 3.5 ? 4 : t > 1.5 ? 2 : 1;
  }
  function Vv(t) {
    return (t /= 2592e6) > 6 ? 6 : t > 3 ? 3 : t > 2 ? 2 : 1;
  }
  function Hv(t) {
    return (t /= xh) > 12 ? 12 : t > 6 ? 6 : t > 3.5 ? 4 : t > 2 ? 2 : 1;
  }
  function Wv(t, e) {
    return (t /= e ? _h : mh) > 30
      ? 30
      ...
      return (
        ...
        (e.prototype.getTicks = function (t) {
          var e = this._originalScale,
            ...
            i = e.getExtent();
          return N(
            Yv.getTicks.call(this, t),
            function (t) {
              var e = t.value,
                r = _r(Kv(this.base, e));
              return (
                (r = e === n[0] && this._fixMin ? tm(r, i[0]) : r),
                { value: (r = e === n[1] && this._fixMax ? tm(r, i[1]) : r) }
              );
            },
            this,
          );
        ...
        (e.prototype.setExtent = function (t, e) {
          ...
          (t = $v(Math.max(0, t)) / n),
            (e = $v(Math.max(0, e)) / n),
            Yv.setExtent.call(this, t, e);
        }),
        (e.prototype.getExtent = function () {
          var t = this.base,
            e = Xv.getExtent.call(this);
          (e[0] = Kv(t, e[0])), (e[1] = Kv(t, e[1]));
          var n = this._originalScale.getExtent();
          return (
            this._fixMin && (e[0] = tm(e[0], n[0])),
            this._fixMax && (e[1] = tm(e[1], n[1])),
            e
          );
        }),
        (e.prototype.unionExtent = function (t) {
        ...
        (e.prototype.calcNiceTicks = function (t) {
          ...
          if (!(n === 1 / 0 || n <= 0)) {
            ...
            for (
              ...
              i *= 10;
            var r = [_r(jv(e[0] / i) * i), _r(Zv(e[1] / i) * i)];
            (this._interval = i), (this._niceExtent = r);
          }
        }),
        (e.prototype.calcNiceExtent = function (t) {
          Yv.calcNiceExtent.call(this, t),
        ...
        (e.prototype.contain = function (t) {
          return wv((t = $v(t) / $v(this.base)), this._extent);
        }),
        (e.prototype.normalize = function (t) {
          return bv((t = $v(t) / $v(this.base)), this._extent);
        }),
        (e.prototype.scale = function (t) {
          return (t = Sv(t, this._extent)), Kv(this.base, t);
        }),
        (e.type = 'log'),
        e
      );
  ...
  (Jv.getMinorTicks = Yv.getMinorTicks),
    (Jv.getLabel = Yv.getLabel),
    pv.registerClass(Qv);
  var em = (function () {
      function t(t, e, n) {
      ...
      return (
        (t.prototype._prepareParams = function (t, e, n) {
          ...
          W(o)
            ? (this._modelMinNum = rm(t, o({ min: n[0], max: n[1] })))
            : 'dataMin' !== o && (this._modelMinNum = rm(t, o));
          var a = (this._modelMaxRaw = e.get('max', !0));
          if (
            (W(a)
              ? (this._modelMaxNum = rm(t, a({ min: n[0], max: n[1] })))
              : 'dataMax' !== a && (this._modelMaxNum = rm(t, a)),
            i)
          )
            ...
            'boolean' == typeof l[0] || 'boolean' == typeof l[1]
              ...
              : (this._boundaryGapInner = [ji(l[0], 1), ji(l[1], 1)]);
          }
        }),
    ...
    nm = { min: '_determinedMin', max: '_determinedMax' },
    im = { min: '_dataMin', max: '_dataMax' };
  function rm(t, e) {
  ...
  function om(t, e) {
    var n = t.type,
      i = (function (t, e, n) {
        ...
        return i || ((i = new em(t, e, n)), (t.rawExtentInfo = i), i);
  ...
  function am(t, e) {
    var n = e,
      ...
      r = i.extent,
      o = n.get('splitNumber');
    t instanceof Qv && (t.base = n.get('logBase'));
    var a = t.type,
      s = n.get('interval'),
      l = 'interval' === a || 'time' === a;
    t.setExtent(r[0], r[1]),
  ...
  function cm(t) {
    return 'category' === t.type && 0 === hm(t.getLabelModel());
  }
  var pm = (function () {
    function t() {}
    return (
  ...
  var fm = {
    isDimensionStacked: uv,
    enableDataStack: lv,
    getStackedDimension: hv,
  };
  var dm = Object.freeze({
    ...
    createScale: function (t, e) {
      var n = e;
      e instanceof lh || (n = new lh(e));
      var i = sm(n);
      return i.setExtent(t[0], t[1]), am(i, n), i;
    },
    ...
    createTextStyle: function (t, e) {
      return Gu(t, null, null, 'normal' !== (e = e || {}).state);
    },
    createDimensions: function (t, e) {
      return iv(t, e).dimensions;
    },
    createSymbol: Bd,
    enableHoverEmphasis: Qs,
  });
  function gm(t, e) {
  ...
  function ym(t, e, n) {
    ...
    for (var o = 1; o < t.length; o++) {
      var a = t[o];
      (i += Ia(r[0], r[1], a[0], a[1], e, n)), (r = a);
    }
    var s = t[0];
    return (
      (gm(r[0], s[0]) && gm(r[1], s[1])) ||
        (i += Ia(r[0], r[1], s[0], s[1], e, n)),
      0 !== i
    );
  }
  var vm = [];
  ...
  function Mm(t, e, n) {
    for (var i = 0; i < t.length; i++) t[i] = Tm(t[i], e[i], n);
  }
  function Tm(t, e, n) {
    ...
    return N(
      ...
      function (t) {
        ...
        switch (i.type) {
          case 'Polygon':
            var o = i.coordinates;
            r.push(new wm(o[0], o.slice(1)));
            break;
          case 'MultiPolygon':
            R(i.coordinates, function (t) {
              t[0] && r.push(new wm(t[0], t.slice(1)));
            });
            break;
          case 'LineString':
            r.push(new bm([i.coordinates]));
            break;
          case 'MultiLineString':
            r.push(new bm(i.coordinates));
        }
        var a = new Sm(n[e || 'name'], r, n.cp);
  ...
  var km = Object.freeze({
      ...
      getPrecision: xr,
      getPrecisionSafe: wr,
      getPixelPrecision: br,
      getPercentWithPrecision: function (t, e, n) {
        return (t[e] && Sr(t, n)[e]) || 0;
      },
    ...
    Dm = Object.freeze({ __proto__: null, parse: Dr, format: Lh }),
    Im = Object.freeze({
      __proto__: null,
      ...
      clipPointsByRect: function (t, e) {
        return N(t, function (t) {
          var n = t[0];
          (n = Tu(n, e.x)), (n = Cu(n, e.x + e.width));
          var i = t[1];
          return (i = Tu(i, e.y)), [n, (i = Cu(i, e.y + e.height))];
        });
      },
      clipRectByRect: function (t, e) {
        var n = Tu(t.x, e.x),
          i = Cu(t.x + t.width, e.x + e.width),
          r = Tu(t.y, e.y),
          o = Cu(t.y + t.height, e.y + e.height);
        if (i >= n && o >= r)
          return { x: n, y: r, width: i - n, height: o - r };
      },
      registerShape: Iu,
      getShapeClass: function (t) {
        if (ku.hasOwnProperty(t)) return ku[t];
      },
      Group: sr,
      Image: Ya,
      Text: es,
      ...
      : 'category' === t.type
        ? (function (t, e) {
            ...
            if (W(o)) n = Hm(t, o, !0);
              ...
              var s = Em(t, t.getLabelModel());
              (i = s.labelCategoryInterval),
                (n = N(s.labels, function (t) {
                  return t.tickValue;
                }));
            } else n = Vm(t, (i = o), !0);
            return Fm(r, o, { ticks: n, tickCategoryInterval: i });
          })(t, e)
        : {
    ...
    return (
      ...
      (W(o)
        ...
        : ((i =
            'auto' === o
              ? (function (t) {
                  var e = Pm(t).autoInterval;
                  return null != e
                    ? e
                    : (Pm(t).autoInterval = t.calculateCategoryInterval());
                })(t)
              : o),
          (n = Vm(t, i))),
      Fm(r, o, { labels: n, labelCategoryInterval: i }))
    );
  }
  function zm(t, e) {
    return Pm(t)[e] || (Pm(t)[e] = []);
  }
  function Bm(t, e) {
    ...
    Gm = (function () {
      ...
      return (
        ...
        (t.prototype.getPixelPrecision = function (t) {
          return br(t || this.scale.getExtent(), this._extent);
        }),
        (t.prototype.setExtent = function (t, e) {
          var n = this._extent;
          (n[0] = t), (n[1] = e);
        ...
        (t.prototype.coordToData = function (t, e) {
          var n = this._extent,
            i = this.scale;
          this.onBand && 'ordinal' === i.type && Um((n = n.slice()), i.count());
          var r = vr(t, n, Wm, e);
        ...
        (t.prototype.getTicksCoords = function (t) {
          ...
          return (
            (function (t, e, n, i) {
              ...
              function c(t, e) {
                return (t = _r(t)), (e = _r(e)), h ? t > e : t < e;
              }
        ...
        (t.prototype.calculateCategoryInterval = function () {
          return (function (t) {
            ...
            for (
              ...
              var d,
                g,
                y = Xi(n({ value: l }), e.font, 'center', 'top');
              (d = 1.3 * y.width),
                (g = 1.3 * y.height),
                (p = Math.max(p, d, 7)),
                (f = Math.max(f, g, 7));
  ...
  function Jm(t, e) {
    if (e <= 180 && e > 0) {
      ...
      var n = jm.len(),
        i = Km.len();
      if (!(n < 0.001 || i < 0.001)) {
        jm.scale(1 / n), Km.scale(1 / i);
        var r = jm.dot(Km);
        if (Math.cos(e) < r) {
          var o = Xm(qm.x, qm.y, Zm.x, Zm.y, Ym.x, Ym.y, $m, !1);
          Qm.fromArray($m), Qm.scaleAndAdd(Km, o / Math.tan(Math.PI - e));
          var a =
            Zm.x !== qm.x
              ? (Qm.x - qm.x) / (Zm.x - qm.x)
              : (Qm.y - qm.y) / (Zm.y - qm.y);
          if (isNaN(a)) return;
          a < 0 ? ve.copy(Qm, qm) : a > 1 && ve.copy(Qm, Zm), Qm.toArray(t[1]);
        }
      }
    }
  }
  function t_(t, e, n) {
    if (n <= 180 && n > 0) {
      ...
      var i = jm.len(),
        r = Km.len();
      if (!(i < 0.001 || r < 0.001))
        if ((jm.scale(1 / i), Km.scale(1 / r), jm.dot(e) < Math.cos(n))) {
          var o = Xm(qm.x, qm.y, Zm.x, Zm.y, Ym.x, Ym.y, $m, !1);
          Qm.fromArray($m);
          var a = Math.PI / 2,
            s = a + Math.acos(Km.dot(e)) - n;
          if (s >= a) ve.copy(Qm, Zm);
          else {
            Qm.scaleAndAdd(Km, o / Math.tan(Math.PI / 2 - s));
            var l =
              Zm.x !== qm.x
                ? (Qm.x - qm.x) / (Zm.x - qm.x)
                : (Qm.y - qm.y) / (Zm.y - qm.y);
            if (isNaN(l)) return;
            l < 0 ? ve.copy(Qm, qm) : l > 1 && ve.copy(Qm, Zm);
          }
          Qm.toArray(t[1]);
        }
    }
  ...
  var o_ = (function (t) {
      function e(e, n, i) {
        ...
        (o.motionBlur = !1),
          ...
          (i = i || Ai),
          'string' == typeof e ? (r = r_(e, n, i)) : Y(e) && (e = (r = e).id),
          (o.id = e),
          (o.dom = r);
        var a = r.style;
        return (
      ...
      return (
        ...
        (e.prototype.createBackBuffer = function () {
          var t = this.dpr;
          (this.domBack = r_('back-' + this.id, this.painter, t)),
        ...
        (e.prototype.createRepaintRects = function (t, e, n, i) {
          ...
          for (h = this.__prevStartIndex; h < this.__prevEndIndex; ++h) {
            var f, d;
            c = (f = e[h]) && f.shouldBePainted(n, i, !0, !0);
              ...
              if (K(e))
                (a =
                  ((e.global || (e.__width === i && e.__height === o)) &&
                    e.__canvasGradient) ||
                  Hd(r, e, { x: 0, y: 0, width: i, height: o })),
  ...
  var u_ = (function () {
    function t(t, e, n, i) {
      ...
      if (r) {
        ...
        (this._width = Gd(t, 0, n)), (this._height = Gd(t, 1, n));
    ...
    return (
      ...
      (t.prototype._paintHoverList = function (t) {
        ...
        if ((n && n.clear(), e)) {
          for (
            ...
            var a = t[o];
            a.__inHover &&
              (n || (n = this._hoverlayer = this.getLayer(a_)),
              i || (i = n.ctx).save(),
              ag(i, a, r, o === e - 1));
          }
          i && i.restore();
      ...
      (t.prototype._doPaintEl = function (t, e, n, i, r, o) {
        ...
        if (n) {
          ...
          (!i || (s && s.intersect(i))) &&
            (ag(a, t, r, o), t.setPrevPaintRect(s));
        } else ag(a, t, r, o);
      }),
      (t.prototype.getLayer = function (t, e) {
        this._singleCanvas && !this._needsManuallyCompositing && (t = s_);
        var n = this._layers[t];
        return (
          n ||
            (((n = new o_('zr_' + t, this, this.dpr)).zlevel = t),
            (n.__builtin__ = !0),
            this._layerConfig[t]
              ? C(n, this._layerConfig[t], !0)
              : this._layerConfig[t - l_] &&
                C(n, this._layerConfig[t - l_], !0),
            e && (n.virtual = e),
      ...
      (t.prototype.configLayer = function (t, e) {
        if (e) {
          ...
          for (var i = 0; i < this._zlevelList.length; i++) {
            ...
            if (r === t || r === t + l_) C(this._layers[r], n[t], !0);
          }
        }
      }),
      ...
      (t.prototype.resize = function (t, e) {
        if (this._domRoot.style) {
          ...
          (this._width = t), (this._height = e), this.getLayer(s_).resize(t, e);
        }
        return this;
      }),
      ...
      (t.prototype.getRenderedCanvas = function (t) {
        ...
        var e = new o_('image', this, t.pixelRatio || this.dpr);
        e.initContext(),
  ...
  var h_ = (function (t) {
    ...
    return (
      ...
      (e.prototype.getInitialData = function (t) {
        return cv(null, this, { useEncodeDefaulter: !0 });
      }),
  ...
  function c_(t, e) {
    ...
    if (i) {
      for (var o = [], a = 0; a < n.length; a++) o.push(Gp(t, e, n[a]));
      return o.join(' ');
    }
  }
  function p_(t, e) {
  ...
  var f_ = (function (t) {
    ...
    return (
      ...
      (e.prototype.updateData = function (t, n, i, r) {
        ...
        if ((this._updateCommon(t, n, s, i, r), l)) {
          ...
          if (!u) {
            ...
            (p.scaleX = p.scaleY = 0), (p.style.opacity = 0), _u(p, c, a, n);
          }
        }
      ...
      (e.prototype._updateCommon = function (t, e, n, i, r) {
        ...
        var _ = Fd(t.getItemVisual(e, 'symbolOffset'), n);
        ...
        if (d instanceof Ya) {
          ...
          d.__isEmptyBrush ? d.useStyle(k({}, x)) : d.useStyle(x),
            (d.style.decal = null),
        ...
        var D =
          null == p || !0 === p
            ...
            : isFinite(p) && p > 0
              ? +p
              : 1;
        (C.scaleX = this._sizeX * D),
          (C.scaleY = this._sizeY * D),
      ...
      (e.prototype.fadeOut = function (t, e, n) {
        ...
        wu(i, { style: { opacity: 0 }, scaleX: 0, scaleY: 0 }, e, {
          dataIndex: r,
          cb: t,
          removeOpt: o,
        });
  ...
  function v_(t) {
    ...
    return {
      ...
      labelStatesModels: Wu(e),
      cursorStyle: e.get('cursor'),
    };
  }
  var m_ = (function () {
    function t(t) {
      (this.group = new sr()), (this._SymbolCtor = t || f_);
    }
    return (
      (t.prototype.updateData = function (t, e) {
        (this._progressiveEls = null), (e = y_(e));
        var n = this.group,
          i = t.hostModel,
          r = this._data,
          o = this._SymbolCtor,
      ...
      (t.prototype.eachRendered = function (t) {
        Bu(this._progressiveEls || this.group, t);
      }),
      (t.prototype.remove = function (t) {
        var e = this.group,
          n = this._data;
          ...
          if (M >= i || S_(b, S)) (f = v), (d = m);
            ...
            if ('x' === s) {
              ...
              (R = Math.sqrt(A * A + P * P)),
                ...
                (d = m - k * a * (1 - T)),
                (I = m + k * a * T),
                (D = w_((D = v + C * a * T), b_(b, v))),
                (I = w_(I, b_(S, m))),
                (D = b_(D, w_(b, v))),
                (d = m - ((k = (I = b_(I, w_(S, m))) - m) * R) / N),
                (f = w_((f = v - ((C = D - v) * R) / N), b_(u, v))),
                (d = w_(d, b_(h, m))),
                (D = v + ((C = v - (f = b_(f, w_(u, v)))) * N) / R),
                (I = m + ((k = m - (d = b_(d, w_(h, m)))) * N) / R);
          }
          t.bezierCurveTo(c, p, f, d, v, m), (c = D), (p = I);
        } else t.lineTo(v, m);
      }
      (u = v), (h = m), (g += o);
    }
      ...
      return (
        ...
        (e.prototype.buildPath = function (t, e) {
          var n = e.points,
            ...
            r = n.length / 2;
          if (e.connectNulls) {
            for (; r > 0 && S_(n[2 * r - 2], n[2 * r - 1]); r--);
            for (; i < r && S_(n[2 * i], n[2 * i + 1]); i++);
          }
          for (; i < r; )
            i +=
              M_(t, n, i, r, r, 1, e.smooth, e.smoothMonotone, e.connectNulls) +
              1;
        }),
      ...
      return (
        ...
        (e.prototype.buildPath = function (t, e) {
          var n = e.points,
            ...
            a = e.smoothMonotone;
          if (e.connectNulls) {
            for (; o > 0 && S_(n[2 * o - 2], n[2 * o - 1]); o--);
            for (; r < o && S_(n[2 * r], n[2 * r + 1]); r++);
          }
          for (; r < o; ) {
            var s = M_(t, n, r, o, o, 1, e.smooth, a, e.connectNulls);
            M_(t, i, r + s - 1, s, o, -1, e.stackedOnSmooth, a, e.connectNulls),
              (r += s + 1),
              t.closePath();
          }
        }),
  ...
  function I_(t, e, n, i, r) {
    ...
    if (e) {
      ...
      var g = W(r)
        ...
        : null;
      _u(c, { shape: { width: l, height: u, x: a, y: s } }, n, null, i, g);
    }
    return c;
  }
  function A_(t, e, n) {
    ...
    e &&
      ('angle' === t.getBaseAxis().dim
        ...
        : (a.shape.r = r),
      _u(a, { shape: { endAngle: i.endAngle, r: o } }, n));
    return a;
  }
  function L_(t, e) {
    return t.type === e;
        ...
        (!r ||
          !(function (t, e) {
            ...
            for (
              ...
              if (1.5 * f_.getSymbolSize(e, a)[t.isHorizontal() ? 1 : 0] > i)
                return !1;
            return !0;
          })(o, e))
      ) {
  ...
  function V_(t) {
    ...
    for (var e = 0; e < ms.length; e++)
      if (t.get([ms[e], 'endLabel', 'show'])) return !0;
    return !1;
  }
  function H_(t, e, n, i) {
    if (L_(e, 'cartesian2d')) {
  ...
  var W_ = (function (t) {
    ...
    return (
      ...
      (e.prototype.render = function (t, e, n) {
        var i = this,
          ...
          x =
            ...
            (function (t, e, n) {
              ...
              for (var i = e.count(), r = Iv(2 * i), o = 0; o < i; o++) {
                var a = x_(n, t, e, o);
        ...
        var k = z_(a, r, n) || a.getVisual('style')[a.getVisual('drawType')];
        if (f && c.type === r.type && C === this._step) {
          v && !d
            ? (d = this._newPolygon(u, x))
            : d && !v && (g.remove(d), (d = this._polygon = null)),
            h || this._initOrUpdateEndLabel(t, r, Jh(k));
          var I = g.getClipPath();
          if (I) _u(I, { shape: H_(this, r, !1, t).shape }, t);
          else g.setClipPath(H_(this, r, !0, t));
          w &&
            p.updateData(a, {
              isIgnore: S,
              clipShape: T,
            ...
            (P_(this._stackedOnPoints, x) && P_(this._points, u)) ||
              (y
                ? this._doUpdateAnimation(a, x, r, n, C, m, b)
                : (C && ((u = E_(u, r, C, b)), x && (x = E_(x, r, C, b))),
                  f.setShape({ points: u }),
          ...
          w &&
            ...
            h || this._initOrUpdateEndLabel(t, r, Jh(k)),
            g.setClipPath(H_(this, r, !0, t));
        var A = t.getModel('emphasis'),
          L = A.get('focus'),
          P = A.get('blurScope'),
          O = A.get('disabled');
        (f.useStyle(
          D(s.getLineStyle(), { fill: 'none', stroke: k, lineJoin: 'bevel' }),
        ),
        nl(f, t, 'lineStyle'),
        f.style.lineWidth > 0 &&
          'bolder' === t.get(['emphasis', 'lineStyle', 'width'])) &&
          (f.getState('emphasis').style.lineWidth = +f.style.lineWidth + 1);
        (fs(f).seriesIndex = t.seriesIndex), Js(f, L, P, O);
        var R = N_(t.get('smooth')),
        ...
        if (
          ...
          d.useStyle(
            ...
            nl(d, t, 'areaStyle'),
            (fs(d).seriesIndex = t.seriesIndex),
            Js(d, L, P, O);
        }
        var B = function (t) {
        ...
        if (
          ...
          if (!s) {
            ...
            var h = t.get('zlevel') || 0,
              c = t.get('z') || 0;
            ((s = new f_(r, o)).x = l), (s.y = u), s.setZ(h, c);
          ...
          s.highlight();
        } else Nf.prototype.highlight.call(this, t, e, n, i);
      }),
        ...
        if ((this._changePolyState('normal'), null != o && o >= 0)) {
          ...
          a &&
            (a.__temp
              ...
              : a.downplay());
        } else Nf.prototype.downplay.call(this, t, e, n, i);
      }),
      (e.prototype._changePolyState = function (t) {
        var e = this._polygon;
        Ns(this._polyline, t), e && Ns(e, t);
      }),
      ...
      (e.prototype._initOrUpdateEndLabel = function (t, e, n) {
        ...
        if (V_(t)) {
          ...
          s ||
            (((s = this._endLabel = new es({ z2: 200 })).ignoreClip = !0),
      ...
      (e.prototype._endLabelOnDuring = function (t, e, n, i, r, o, a) {
        ...
        if (s) {
          ...
          if (M >= 1) {
                  ...
                  for (
                    ...
                    if (c && 'ordinal' === c.type)
                      ...
                      var p = s && s[h] ? s[h] : 0,
                        f = l[h],
                        d = Br(p, f, r);
                      a[h] = _r(d, o ? Math.max(xr(p), xr(f)) : e);
                    }
                  }
                  return a;
                })(n, p, k, D, b.t));
            ...
            var I = 1 === t || i.lastFrameIndex > 0 ? S[0] : 0;
            C = F_(u, I);
            r && (T = h.getRawValue(I)), s.attr({ x: C[0] + _, y: C[1] + x });
          }
          if (r) {
            var A = ju(s);
      ...
      (e.prototype._doUpdateAnimation = function (t, e, n, i, r, o, a) {
          ...
          h = (function (t, e, n, i, r, o, a, s) {
            for (
              ...
              switch (x.cmd) {
                ...
                case '+':
                  var D = x.idx,
                    I = y.dataDimsForPoint,
                    A = r.dataToPoint([e.get(I[0], D), e.get(I[1], D)]);
                  (S = 2 * D), u.push(A[0], A[1]), h.push(m[S], m[S + 1]);
                  var L = x_(y, r, e, D);
                  c.push(L[0], L[1]),
                    p.push(i[S], i[S + 1]),
        ...
        if (
          (r &&
            ((c = E_(h.current, n, r, a)),
            (p = E_(h.stackedOnCurrent, n, r, a)),
            (f = E_(h.next, n, r, a)),
            (d = E_(h.stackedOnNext, n, r, a))),
          R_(c, f) > 3e3 || (l && R_(p, d) > 3e3))
        )
          return (
            s.stopAnimation(),
            s.setShape({ points: f }),
        ...
        h.current !== c && (g.shape.__points = h.next),
          ...
          l &&
            ...
            l.stopAnimation(),
            mu(l, { shape: { stackedOnPoints: d } }, u),
      ...
      reset: function (t, e, n) {
        ...
        if (a > 10 && 'cartesian2d' === o.type && r) {
          ...
          if (isFinite(p) && p > 1) {
            ...
            var f = void 0;
            G(r) ? (f = G_[r]) : W(r) && (f = r),
              f && t.setData(i.downSample(i.mapDimension(l.dim), 1 / p, f, U_));
          }
        }
      },
    };
            ...
            R(i.getAxes(), function (t, n) {
              if ('category' === t.type && null != e) {
                ...
                for (
                  ...
                  1 === p && (c = d - i[0].tickValue);
                }
                null == h &&
                  (u ? u && (h = i[i.length - 1].coord) : (h = i[0].coord)),
      ...
      return (
        ...
        (e.prototype._renderNormal = function (t, e, n, i) {
          ...
          function b(t) {
            var e = ux[l.type](a, t),
              n = (function (t, e, n) {
                var i = 'polar' === t.type ? Wl : Qa;
                return new i({ shape: yx(e, n, t), silent: !0, z2: 0 });
              })(l, r, e);
            return (
          ...
          a.diff(s)
            .add(function (e) {
              var n = a.getItemModel(e),
                i = ux[l.type](a, e, n);
              if ((g && b(e), a.hasValue(e) && lx[l.type](i))) {
                var s = !1;
                p && (s = nx[l.type](f, i));
                var y = ix[l.type](t, a, e, i, r, h, u.model, !1, d);
                c && (y.forceLabelAnimation = !0),
                  cx(y, a, e, n, i, t, r, 'polar' === l.type),
                  x
                    ? y.attr({ shape: i })
                    : c
                      ? rx(c, h, y, i, e, r, !1, !1)
              ...
              if (g) {
                ...
                0 === _.length
                  ...
                  : ((M = _[n]).useStyle(y.getItemStyle()),
                    ...
                    (m[e] = M));
                var T = ux[l.type](a, e);
                mu(M, { shape: yx(r, T, l) }, h, e);
              }
              var C = s.getItemGraphicEl(n);
              if (a.hasValue(e) && lx[l.type](S)) {
                var k = !1;
                if (
                  (p && (k = nx[l.type](f, S)) && o.remove(C),
                  C
                    ? Mu(C)
                    : (C = ix[l.type](t, a, e, S, r, h, u.model, !!C, d)),
                  ...
                  if (D) {
                    var I = ju(D);
                    null != I.prevValue && (I.prevValue = I.value);
                  }
                } else cx(C, a, e, i, S, t, r, 'polar' === l.type);
                x
                  ? C.attr({ shape: S })
                  : c
                    ? rx(c, h, C, S, e, r, !0, w)
                    : mu(C, { shape: S }, t, e, null),
            ...
            .execute();
          var S = this._backgroundGroup || (this._backgroundGroup = new sr());
          S.removeAll();
          for (var M = 0; M < m.length; ++M) S.add(m[M]);
          o.add(S), (this._backgroundEls = m), (this._data = a);
        }),
        (e.prototype._renderLarge = function (t, e, n) {
          this._clear(), dx(t, this.group), this._updateLargeClip(t);
        }),
        (e.prototype._incrementalRenderLarge = function (t, e) {
          this._removeBackground(), dx(e, this.group, this._progressiveEls, !0);
        }),
      ...
      polar: function (t, e, n, i, r, o, a, s, l) {
        ...
        if (
          ((h.calculateTextPosition =
            ((c = f),
            (p = ({ isRoundCap: u === j_ } || {}).isRoundCap),
            function (t, e, n) {
              var i = e.position;
              if (!i || i instanceof Array) return Ki(t, e, n);
              var r = c(i),
  ...
  function rx(t, e, n, i, r, o, a, s) {
    ...
    o
      ...
      s || (a ? mu : _u)(n, { shape: l }, e, r, null),
      (a ? mu : _u)(n, { shape: u }, e ? t.baseAxis.model : null, r);
  }
  function ox(t, e) {
    for (var n = 0; n < e.length; n++) if (!isFinite(t[e[n]])) return !0;
    return !1;
  }
  var ax = ['x', 'y', 'width', 'height'],
    sx = ['cx', 'cy', 'r', 'startAngle', 'endAngle'],
    lx = {
  ...
  function cx(t, e, n, i, r, o, a, s) {
    var l = e.getItemVisual(n, 'style');
    if (s) {
      if (!o.get('roundCap')) {
        var u = t.shape;
        k(u, Q_(i.getModel('itemStyle'), u, !0)), t.setShape(u);
      }
    } else {
    ...
    if (s && d) {
      ...
      (t.textConfig.inside = 'middle' === g || null),
        ...
        })(t, 'outside' === g ? p : g, hx(a), i.get(['label', 'rotate']));
    }
    !(function (t, e, n, i) {
      if (t) {
        var r = ju(t);
    ...
    Js(t, y.get('focus'), y.get('blurScope'), y.get('disabled')),
      nl(t, i),
      (function (t) {
        return (
          null != t.startAngle &&
  ...
  function dx(t, e, n, i) {
    ...
    (c.baseDimIdx = o),
      ...
      (fs(c).seriesIndex = t.seriesIndex),
      t.get('silent') || (c.on('mousedown', gx), c.on('mousemove', gx)),
      n && n.push(c);
  }
  var gx = Hf(
    function (t) {
  ...
  var vx = 2 * Math.PI,
    mx = Math.PI / 180;
  function _x(t, e) {
    return rc(t.getBoxLayoutParams(), {
      width: e.getWidth(),
      height: e.getHeight(),
    });
  }
  function xx(t, e) {
    ...
    var o,
      a,
      s = mr(n.width, e.getWidth()),
      l = mr(n.height, e.getHeight()),
      u = Math.min(s, l),
      h = mr(r[0], u / 2),
      c = mr(r[1], u / 2),
    ...
    if (p) {
      ...
      H(i) || (i = [i, i]), (o = mr(i[0], s) + n.x), (a = mr(i[1], l) + n.y);
  ...
  function bx(t, e, n) {
    e.eachSeriesByType(t, function (t) {
      var e = t.getData(),
        ...
        l = o.r,
        u = o.r0,
        h = -t.get('startAngle') * mx,
        c = t.get('endAngle'),
        p = t.get('padAngle') * mx;
      c = 'auto' === c ? h - vx : -c * mx;
      var f = t.get('minAngle') * mx + p,
        d = 0;
      e.each(i, function (t) {
        !isNaN(t) && d++;
      });
      ...
      if (
        ...
        e.each(i, function (t, n) {
          ...
          if (isNaN(t))
            ...
            (i = 'area' !== m ? (0 === g && _ ? y : t * y) : T / d) < f
              ? ((i = f), (C -= f))
              : (k += t);
            var r = D + w * i,
              o = 0,
              h = 0;
            p > i ? (h = o = D + (w * i) / 2) : ((o = D + S), (h = r - S)),
              e.setItemLayout(n, {
                angle: i,
                startAngle: o,
                endAngle: h,
  ...
  var Sx = Qr();
  var Mx = Math.PI / 180;
  function Tx(t, e, n, i, r, o, a, s, l, u) {
    if (!(t.length < 2)) {
    ...
    function f(t) {
      for (var o = t.rB, a = o * o, s = 0; s < t.list.length; s++) {
        var l = t.list[s],
          ...
          f = e + (p + l.len2) * r,
          d = f - l.label.x;
        Cx(l, l.targetTextWidth - d * r, !0), (l.label.x = f);
      }
    }
  }
  function Cx(t, e, n) {
  ...
  function Dx(t) {
    ...
    i.each(function (t) {
      var s = i.getItemGraphicEl(t),
        ...
        _ = y.get('alignTo'),
        x = mr(y.get('edgeDistance'), u),
        w = y.get('bleedMargin'),
        b = g.getModel('labelLine'),
        S = b.get('length');
      S = mr(S, u);
      var M = b.get('length2');
      if (((M = mr(M, u)), Math.abs(c.endAngle - c.startAngle) < a))
        return (
          R(p.states, f),
          (p.ignore = !0),
      ...
      if (
        ...
        var T,
          ...
          k,
          D,
          I = (c.startAngle + c.endAngle) / 2,
          A = Math.cos(I),
          L = Math.sin(I);
        (e = c.cx), (n = c.cy);
        var P = 'inside' === v || 'inner' === v;
        if ('center' === v) (T = c.cx), (C = c.cy), (D = 'center');
        else {
      ...
      !o &&
        ...
        (function (t, e, n, i, r, o, a, s) {
          ...
          for (
            Tx(u, e, n, i, 1, 0, o, 0, s, c),
              Tx(l, e, n, i, -1, 0, o, 0, s, h),
              p = 0;
            p < t.length;
            p++
          ) {
    ...
    for (var d = 0; d < r.length; d++) {
      ...
      if (v) {
        ...
        m || !x
          ...
          : (Jm(x, g.minTurnAngle),
            t_(x, g.surfaceNormal, g.maxSurfaceAngle),
            v.setShape({ points: x }),
      ...
      return (
        ...
        (e.prototype.updateData = function (t, e, n, i) {
          var r = this,
            ...
            l = t.getItemLayout(e),
            u = k(Q_(a.getModel('itemStyle'), l, !0), l);
          if (isNaN(u.startAngle)) r.setShape(u);
            ...
            if (i) {
              ...
              o.ecModel.ssr
                ? (_u(r, { scaleX: 0, scaleY: 0 }, o, {
                  ...
                  (r.originY = u.cy))
                : 'scale' === h
                  ? ((r.shape.r = l.r0), _u(r, { shape: { r: l.r } }, o, e))
                  : null != n
                    ...
                    : ((r.shape.endAngle = l.startAngle),
                      mu(r, { shape: { endAngle: l.endAngle } }, o, e));
            } else Mu(r), mu(r, { shape: u }, o, e);
            r.useStyle(t.getItemVisual(e, 'style')), nl(r, a);
            ...
            g && r.attr('cursor', g),
              ...
              (r.ensureState('emphasis').shape = k(
                { r: l.r + ((s.get('scale') && s.get('scaleSize')) || 0) },
                Q_(s.getModel('itemStyle'), l),
              )),
              k(r.ensureState('select'), {
                x: f,
                y: d,
                shape: Q_(a.getModel(['select', 'itemStyle']), l),
              }),
              k(r.ensureState('blur'), {
                shape: Q_(a.getModel(['blur', 'itemStyle']), l),
              });
            var y = r.getTextGuideLine(),
              v = r.getTextContent();
            y && k(y.ensureState('select'), { x: f, y: d }),
              k(v.ensureState('select'), { x: f, y: d }),
              Js(this, s.get('focus'), s.get('blurScope'), s.get('disabled'));
          }
        }),
        (e.prototype._updateLabel = function (t, e, n) {
          ...
          if ('outside' !== h && 'outer' !== h) i.removeTextGuideLine();
            ...
            c || ((c = new jl()), this.setTextGuideLine(c)),
              (function (t, e, n) {
                  ...
                  for (
                    ...
                    if (h) {
                      ...
                      if (
                        ...
                        f && (f.ignore = !0), i && e_(i, !0, u, h);
                        continue;
                      }
                      i ||
                        ((i = new jl()),
                        t.setTextGuideLine(i),
                        c || (!s && a) || e_(i, !0, 'normal', e.normal),
                        t.stateProxy && (i.stateProxy = t.stateProxy)),
                        e_(i, !1, u, h);
                    }
                  }
                  if (i) {
                    D(i.style, n), (i.style.fill = null);
      ...
      return (
        ...
        (e.prototype.render = function (t, e, n, i) {
          ...
          if (
            ...
            var h = Sx(t),
              c = new Wl({ shape: k(xx(t, n), h) });
            c.useStyle(t.getModel('emptyCircleStyle').getItemStyle()),
      ...
      return (
        ...
        (e.prototype.init = function (e) {
          t.prototype.init.apply(this, arguments),
            (this.legendVisualProvider = new Lx(
              F(this.getData, this),
        ...
        (e.prototype.getDataParams = function (e) {
          ...
          if (!r) {
            ...
            n.each(n.mapDimension('value'), function (t) {
              ...
              (r = i.seats = Sr(o, n.hostModel.get('percentPrecision')));
          }
    ...
    Nx = (function (t) {
      ...
      return (
        ...
        (e.prototype.getCoordSysModel = function () {
          return this.getReferringComponents('grid', no).models[0];
        }),
  ...
  var Ex = {
    ...
    Vx = { value: 1, category: 1, time: 1, log: 1 };
  function Hx(t, e, i, r) {
    R(Vx, function (o, a) {
      var s = C(C({}, Fx[a], !0), r, !0),
        l = (function (t) {
          function i() {
            var n = (null !== t && t.apply(this, arguments)) || this;
      ...
      t.registerSubTypeDefaulter(e + 'Axis', Wx);
  }
  function Wx(t) {
  ...
  var Yx = (function (t) {
      function e() {
        var e = (null !== t && t.apply(this, arguments)) || this;
        return (e.type = 'cartesian2d'), (e.dimensions = Ux), e;
      }
      return (
        n(e, t),
    ...
    return (
      R(e, function (n, i) {
        var r = i.replace(/Model$/, ''),
          o = t.getReferringComponents(r, no).models[0];
        e[i] = o;
      }),
      e
    );
  ...
  function $x(t, e, n) {
    ...
    if (h && c) d = (y - g) / a;
      ...
      t.getTicks().length - 1 > a && (d = mv(d));
      var v = d * a;
      (g = _r((y = Math.ceil(u[1] / d) * d) - v)) < 0 && u[0] >= 0
        ? ((g = 0), (y = _r(v)))
        : y > 0 && u[1] <= 0 && ((y = 0), (g = -_r(v)));
    }
    ...
    return (
          ...
          if (i) {
            for (var r = [], o = i - 1; o >= 0; o--) {
              var a = t[+n[o]],
                s = a.model,
                l = a.scale;
              yv(l) && s.get('alignTicks') && null == s.get('interval')
                ? r.push(a)
                : (am(l, s), yv(l) && (e = a));
            }
            r.length &&
              (e || am((e = r.pop()).scale, e.model),
              R(r, function (t) {
                $x(t.scale, t.model, e.scale);
              }));
          }
        }
      ...
      (t.prototype.resize = function (t, e, n) {
        var i = t.getBoxLayoutParams(),
          ...
          o = rc(i, { width: e.getWidth(), height: e.getHeight() });
        this._rect = o;
                ...
                var e = (function (t) {
                  ...
                  if (e.get(['axisLabel', 'show']) && !n.isBlank()) {
                    var i,
                      r,
                      o = n.getExtent();
                    r = n instanceof Mv ? n.count() : (i = n.getTicks()).length;
                    var a,
                      s = t.getLabelModel(),
                      l = lm(t),
                      u = 1;
                    ...
                    for (var h = 0; h < r; h += u) {
                      var c = l(i ? i[h] : { value: o[0] + h }, h),
                        p = um(s.getTextRect(c), s.get('rotate') || 0);
                      a ? a.union(p) : (a = p);
                    }
                    return a;
                  }
      ...
      (t.prototype._findConvertTarget = function (t) {
        var e,
          ...
          r =
            t.xAxisModel ||
            (i && i.getReferringComponents('xAxis', no).models[0]),
          o =
            t.yAxisModel ||
            (i && i.getReferringComponents('yAxis', no).models[0]),
          a = t.gridModel,
          s = this._coordsList;
            ...
            if (Jx(n, t)) {
              ...
              'x' === e
                ...
                : 'left' !== l &&
                  ...
                  (l = o.left ? 'right' : 'left'),
                (o[l] = !0);
              var u = new qx(e, sm(n), [0, 0], n.get('type'), l),
                h = 'category' === u.type;
  ...
  function tw(t, e, n, i) {
    ...
    if (s) {
      if (null != l) ew(o[l]) && (r = o[l]);
      else
        for (var u in o)
          if (o.hasOwnProperty(u) && ew(o[u]) && !i[h(o[u])]) {
            r = o[u];
            break;
          }
      r && (i[h(r)] = !0);
  ...
  var nw = Math.PI,
    iw = (function () {
      ...
      return (
        ...
        (t.prototype.add = function (t) {
          rw[t](this.opt, this.axisModel, this.group, this._transformGroup);
        }),
    ...
    rw = {
      axisLine: function (t, e, n, i) {
        ...
        if (
          ...
          Nu(c.shape, c.style.lineWidth), (c.anid = 'line'), n.add(c);
          var p = e.get(['axisLine', 'symbol']);
          if (null != p) {
            var f = e.get(['axisLine', 'symbolSize']);
            G(p) && (p = [p, p]), (G(f) || X(f)) && (f = [f, f]);
            var d = Fd(e.get(['axisLine', 'symbolOffset']) || 0, f),
              g = f[0],
              y = f[1];
            R(
              [
              ...
              function (e, i) {
                if ('none' !== p[i] && null != p[i]) {
                  var r = Bd(p[i], -g / 2, -y / 2, g, y, h.stroke, !0),
                    o = e.r + e.offset,
                    a = u ? l : s;
                  r.attr({
                    rotation: e.rotate,
      ...
      axisTickLabel: function (t, e, n, i) {
        var r = (function (t, e, n, i) {
          ...
          o = (function (t, e, n, i) {
            ...
            var a = n.getModel('axisLabel'),
              s = a.get('margin'),
              l = r.getViewLabels(),
              u = ((tt(i.labelRotate, a.get('rotate')) || 0) * nw) / 180,
              h = iw.innerTextLayout(i.rotation, u, i.labelDirection),
              c = n.getCategories && n.getCategories(!0),
              p = [],
              f = iw.isLabelSilent(n),
            ...
            return (
              R(l, function (o, u) {
                ...
                if (c && c[g]) {
                  ...
                  Y(_) &&
                    _.textStyle &&
                    (m = new lh(_.textStyle, a, n.ecModel));
                }
                var x =
                    m.getTextColor() ||
                    n.get(['axisLine', 'lineStyle', 'color']),
                  w = r.dataToCoord(g),
                  b = m.getShallow('align', !0) || h.textAlign,
                  S = et(m.getShallow('alignMinLabel', !0), b),
                  M = et(m.getShallow('alignMaxLabel', !0), b),
                  T =
                    m.getShallow('verticalAlign', !0) ||
                    m.getShallow('baseline', !0) ||
                    h.textVerticalAlign,
                  C = et(m.getShallow('verticalAlignMinLabel', !0), T),
                  k = et(m.getShallow('verticalAlignMaxLabel', !0), T),
                  D = new es({
                    x: w,
                    ...
                    style: Gu(m, {
                      text: y,
                      align: 0 === u ? S : u === l.length - 1 ? M : b,
                      verticalAlign: 0 === u ? C : u === l.length - 1 ? k : T,
                      fill: W(x)
                        ? x(
                            'category' === r.type
                              ? v
                ...
                if (((D.anid = 'label_' + g), d)) {
                  var I = iw.makeAxisEventDataBase(n);
                  (I.targetType = 'axisLabel'),
                    (I.value = v),
                    (I.tickIndex = u),
                    'category' === r.type && (I.dataIndex = g),
                    (fs(D).eventData = I);
                }
                e.add(D),
                  D.updateTransform(),
        ...
        ((function (t, e, n) {
          ...
          !1 === i
            ? (ow(o), ow(u))
            : aw(o, a) && (i ? (ow(a), ow(h)) : (ow(o), ow(u)));
          !1 === r
            ? (ow(s), ow(c))
            : aw(l, s) && (r ? (ow(l), ow(p)) : (ow(s), ow(c)));
        })(e, o, r),
        (function (t, e, n, i) {
          var r = n.axis,
          ...
          for (
            var s = o.getModel('lineStyle'),
              ...
              u = D(
                s.getLineStyle(),
                D(n.getModel('axisTick').getLineStyle(), {
                  stroke: n.get(['axisLine', 'lineStyle', 'color']),
                }),
              ),
              h = 0;
            ...
            for (
              var c = lw(a[h], e.transform, l, u, 'minorticks_' + h), p = 0;
              p < c.length;
              p++
            )
              t.add(c[p]);
            ...
            for (var r = 0; r < t.length; r++) {
              ...
              for (var c = o.obb, p = !1, f = 0; f < e.length; f++) {
                ...
                if (n.intersect(d.rect)) {
                  ...
                  if (
                    (d.obb || (d.obb = new fu(d.localRect, d.transform)),
                    c || (c = new fu(s, l)),
                    c.intersect(d.obb))
                  ) {
                    p = !0;
      ...
      axisName: function (t, e, n, i) {
        ...
        if (r) {
            ...
            f = [
              'start' === s
                ...
                : 'end' === s
                  ? c[1] + p * h
                  : (c[0] + c[1]) / 2,
              sw(s) ? t.labelOffset + l * h : 0,
            ],
            d = e.get('nameRotate');
          null != d && (d = (d * nw) / 180),
            sw(s)
              ? (o = iw.innerTextLayout(
                  t.rotation,
                  null != d ? d : t.rotation,
                  l,
                ))
          ...
          if (
            ...
            var x = iw.makeAxisEventDataBase(e);
            (x.targetType = 'axisName'), (x.name = r), (fs(_).eventData = x);
          }
  ...
  var dw = ['axisLine', 'axisTickLabel', 'axisName'],
          ...
          if (
                ...
                k(
                  {
                    handleAutoShown: function (t) {
                      for (
                        ...
                        if (yv(n[i].getOtherAxis(e.axis).scale)) return !0;
                      return !1;
                    },
                  },
                  s,
            ...
            R(dw, l.add, l),
              ...
              R(
                gw,
                function (t) {
                  e.get([t, 'show']) && vw[t](this, this._axisGroup, e, a);
                },
                this,
              ),
                  ...
                  if (t && e) {
                    ...
                    e.traverse(function (t) {
                      if (Eu(t) && t.anid) {
                        ...
                        if (e) {
                          var i = o(t);
                          t.attr(o(e)), mu(t, i, n, fs(t).dataIndex);
                        }
                      }
                    });
                  }
          ...
          for (
            ...
            var v = h++ % s.length,
              ...
              _ = new Ql({
                ...
                style: D({ stroke: s[v] }, d),
                silent: !0,
              });
            Nu(_.shape, d.lineWidth), e.add(_);
          }
        }
      },
        ...
        if (l.length)
          for (
            ...
            for (var f = 0; f < l[p].length; f++) {
              ...
              Nu(g.shape, c.lineWidth), e.add(g);
            }
      },
    ...
    ww = { offset: 0 };
  var bw = { label: { enabled: !0 }, decal: { show: !1 } },
    Sw = Qr(),
    Mw = {};
  function Tw(t, e) {
      ...
      C(i.label, t.getLocaleModel().get('aria'), !1),
        ...
        (function () {
          if (n.getModel('decal').get('show')) {
            ...
            t.eachSeries(function (t) {
              if (!t.isColorBySeries()) {
                var n = e.get(t.type);
                n || ((n = {}), e.set(t.type, n)), (Sw(t).scope = n);
              }
            }),
                ...
                if (!t.isSeriesFiltered(e))
                  if (W(e.enableAriaDecal)) e.enableAriaDecal();
                    ...
                    if (e.isColorBySeries()) {
                      var i = Bc(e.ecModel, e.name, Mw, t.getSeriesCount()),
                        r = n.getVisual('decal');
        ...
        (function () {
          ...
          var o = t.getLocaleModel().get('aria'),
            a = n.getModel('label');
          if (((a.option = D(a.option, o)), !a.get('enabled'))) return;
          if (a.get('description'))
            return void i.setAttribute('aria-label', a.get('description'));
          var s,
            l = t.getSeriesCount(),
          ...
          (s += r(
            ...
            t.eachSeries(function (e, n) {
              if (n < c) {
                var i = void 0,
                  o = e.get('name') ? 'withName' : 'withoutName';
                i = r(
                  (i =
                    l > 1
                      ...
                      : a.get(['series', 'single', o])),
                  {
                    ...
                    seriesType:
                      ((_ = e.subType),
                      (x = t.getLocaleModel().get(['series', 'typeNames'])),
                      x[_] || x.chart),
                  },
                );
                var s = e.getData();
                if (s.count() > u)
                  i += r(a.get(['data', 'partialData']), { displayCnt: u });
                else i += a.get(['data', 'allData']);
                for (
                  var h = a.get(['data', 'separator', 'middle']),
                  ...
                  if (g < u) {
                    var y = s.getName(g),
                      v = s.getValues(g),
                      m = a.get(['data', y ? 'withName' : 'withoutName']);
          ...
          var d = a.getModel(['series', 'multiple', 'separator']),
            g = d.get('middle'),
            y = d.get('end');
          (s += f.join(g) + y), i.setAttribute('aria-label', s);
        })();
    }
    function r(t, e) {
      if (!G(t)) return t;
      ...
      return (
        ...
        (e.prototype.init = function (e, n, i) {
          t.prototype.init.call(this, e, n, i),
            (this._sourceManager = new gf(this)),
            yf(this);
        }),
        (e.prototype.mergeOption = function (e, n) {
          t.prototype.mergeOption.call(this, e, n), yf(this);
        }),
        ...
        (e.type = 'dataset'),
        (e.defaultOption = { seriesLayoutBy: xc }),
        e
      );
    })(uc),
    Dw = (function (t) {
  ...
  Ay([
    function (t) {
      t.registerPainter('canvas', u_);
    },
  ]),
    Ay([
      function (t) {
        t.registerChartView(W_),
          t.registerSeriesModel(h_),
          t.registerLayout(
            (function (t, e) {
              return {
                seriesType: t,
          ...
          t.registerProcessor(t.PRIORITY.PROCESSOR.STATISTIC, X_('line'));
      },
      function (t) {
        t.registerChartView(ex),
          t.registerSeriesModel(q_),
          t.registerLayout(t.PRIORITY.VISUAL.LAYOUT, V(Rv, 'bar')),
          t.registerLayout(
                ...
                reset: function (t) {
                  if (Nv(t)) {
                    var e = t.getData(),
                      ...
                      h = uv(e, l) && !!e.getCalculationInfo('stackedOnSeries'),
                      c = r.isHorizontal(),
                      p = (function (t, e) {
          ...
          t.registerProcessor(t.PRIORITY.PROCESSOR.STATISTIC, X_('bar')),
          t.registerAction(
            {
              type: 'changeAxisOrder',
            ...
            R(
              ...
              function (t) {
                e(t[0], function (e, i, r) {
                  (e = k({}, e)),
                    r.dispatchAction(
                      k(e, { type: t[1], seriesIndex: n(i, e) }),
                    );
                });
              },
            );
          })('pie', t.registerAction),
          t.registerLayout(V(bx, 'pie')),
          t.registerProcessor(
            (function (t) {
              return {
                seriesType: t,
    ...
    Ay([
      function (t) {
        t.registerComponentView(xw),
          t.registerComponentModel(Rx),
          t.registerCoordinateSystem('cartesian2d', Qx),
          Hx(t, 'x', Nx, ww),
          Hx(t, 'y', Nx, ww),
          t.registerComponentView(mw),
          t.registerComponentView(_w),
          t.registerPreprocessor(function (t) {
            t.xAxis && t.yAxis && !t.grid && (t.grid = {});
          });
      },
      function (t) {
        t.registerPreprocessor(Cw),
          t.registerVisual(t.PRIORITY.VISUAL.ARIA, Tw);
      },
      function (t) {
        t.registerComponentModel(kw), t.registerComponentView(Dw);
      },
    ]),
    (t.Axis = Gm),
    (t.ChartView = Nf),
    ...
    (t.dataTool = {}),
    (t.dependencies = { zrender: '5.6.0' }),
    (t.disConnect = cy),
    (t.disconnect = hy),
    (t.dispose = function (t) {
      G(t) ? (t = oy[t]) : t instanceof Zg || (t = py(t)),
        t instanceof Zg && !t.isDisposed() && t.dispose();
    }),
    (t.env = r),
    (t.extendChartView = function (t) {
      var e = Nf.extend(t);
      return Nf.registerClass(e), e;
    }),
    ...
    (t.extendComponentView = function (t) {
      var e = Lf.extend(t);
      return Lf.registerClass(e), e;
    }),
    (t.extendSeriesModel = function (t) {
      var e = Sf.extend(t);
      return Sf.registerClass(e), e;
    }),
    (t.format = Am),
    ...
    (t.init = function (t, e, n) {
      ...
      return (
        ...
        i && ro(t, uy, o.id),
        Gg(o),
        dg.trigger('afterinit', o),
        o
      );
    }),
    (t.innerDrawElementOnCanvas = og),
    (t.matrix = ye),
    (t.number = km),
    (t.parseGeoJSON = Cm),
    (t.parseGeoJson = Cm),
    (t.registerAction = _y),
    (t.registerCoordinateSystem = xy),
    (t.registerLayout = wy),
    (t.registerLoading = Ty),
    (t.registerLocale = vh),
    (t.registerMap = Cy),
    (t.registerPostInit = yy),
    (t.registerPostUpdate = vy),
    (t.registerPreprocessor = dy),
    (t.registerProcessor = gy),
    (t.registerTheme = fy),
    (t.registerTransform = ky),
    (t.registerUpdateLifecycle = my),
    (t.registerVisual = by),
