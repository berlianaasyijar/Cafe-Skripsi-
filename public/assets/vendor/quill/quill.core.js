    ...
    var t = {
        ...
        6142: function (t, e, n) {
                ...
                return (
                  (function (t) {
                    ...
                    const d = u ? 1 : 0,
                      p = h ? 1 : 0;
                    return (
                      (e += d + p), l.retain(d), l.delete(p), t + o + d + p
                    );
                  }, 0),
                  l.reduce(
                    (t, e) =>
          ...
          class q {
            ...
            removeFormat(t, e, n) {
              return (
                ([t, e, , n] = P(t, e, n)),
                U.call(this, () => this.editor.removeFormat(t, e), n, t)
              );
            }
        ...
        9629: function (t, e, n) {
          ...
          var W,
            ...
            Y = (W = /[^.]+$/.exec((J && J.keys && J.keys.IE_PROTO) || ''))
              ? 'Symbol(src)_1.' + W
              : '',
            Z = X.toString,
            tt = Q.hasOwnProperty,
        ...
        4162: function (t, e, n) {
          ...
          var $,
            ...
            Q = W.toString,
            J = G.hasOwnProperty,
            Y = ($ = /[^.]+$/.exec((X && X.keys && X.keys.IE_PROTO) || ''))
              ? 'Symbol(src)_1.' + $
              : '',
            Z = G.toString,
            tt = RegExp(
            ...
            return null != (e = t) && Vt(e.length) && !Kt(e)
              ...
              : (function (t) {
                  ...
                  for (var i in Object(t))
                    J.call(t, i) && 'constructor' != i && r.push(i);
                  return r;
                })(t);
            var e;
          }
          ...
          insertContents(t, n) {
            ...
            if (s) {
              const n =
                  'block' === s.type &&
                  (0 === s.delta.length() ||
                    (!this.descendant(e.zo, t)[0] && t < this.length())),
                r =
                  'block' === s.type
                    ? s.delta
