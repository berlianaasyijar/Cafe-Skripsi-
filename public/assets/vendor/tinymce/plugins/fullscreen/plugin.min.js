  ...
  const b = Array.prototype.push,
    ...
    he = [
      ...
      },
      {
        ...
        search: (e) =>
          (q(e, 'safari') || q(e, 'mobile/')) && q(e, 'applewebkit'),
      },
    ],
    ge = [
      {
      ...
      (e) => {
        ...
        return {
          bind: (e) => {
            t.set(e),
              o.throttle(),
              n.set(je('resize', o.throttle)),
              r.set(je('scroll', o.throttle));
          },
          unbind: () => {
            t.on(() => {
              n.clear(), r.clear();
            ...
            ((e) => {
              const t = ((e, t) => {
                ...
                return (1 !== (r = n).nodeType &&
                  ...
                  ? []
                  : S(n.querySelectorAll(e), j);
                var r;
              })('[' + Ge + ']');
              x(t, (t) => {
                const n = V(t, Ge);
                n && 'no-styles' !== n ? ee(t, e.parseStyle(n)) : W(t, 'style'),
                  W(t, Ge);
              });
            })(e.dom),
            p(tt.removeClass),
